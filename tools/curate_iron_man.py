...
def main() -> None:
	write_json(ROOT / "machines/author-ready/stern/iron-man-2010.json", build(False))
	write_json(ROOT / "machines/author-ready/stern/iron-man-vault-edition-2014.json", build(True))
