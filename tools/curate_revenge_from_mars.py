...
SOURCES = [
	...
	{"id": CORE_SOURCE, "kind": "pinmame_core", "uri": "https://github.com/vpinball/pinmame", "revision": PINMAME_REVISION, "locator": "src/wpc/p2k.c: public switch translation, opto polarity, output publication, video layout, exact emulated update/sound/Prism ROM composition, and hardware-generation contract; src/wpc/p2k_names.h: machine-test-verified RFM switch, coil, and lamp tables; src/p2k/README.md lines 7-26, 117-163, and 269-363: driver lineage, update-flash identity, stock versus 1.91 sound-flash reuse, the factory r2 Prism pair's non-pairing with any game update, the warning that every driver's current revision-1 composition is an unchecked factory-shipping assumption, and the qualifier that boot-bank pairing does not change update-flash gameplay", "license": "BSD-3-Clause", "attribution": "PinMAME contributors"},
	{
		...
		"excerpts": [
			{"id": "excerpt.rfm.operations-service-tables", "locator": "PDF pages 86-88; printed pages 2-46 through 2-48", "path": MANUAL_EXCERPT, "sha256": MANUAL_EXCERPT_SHA256, "image": "evidence/excerpts/bally.revenge-from-mars.1999/operations-manual-service-tables.webp", "image_sha256": "b894691e8f4566bfc7c53b4fb6794710098bffbef51d967c324dc64fc1e17d5d", "image_derivation": "Bally_1999_Revenge_From_Mars_Operations_Manual_February_1999_OCR_searchable.pdf page 88, crop box 0.04,0.04,0.96,0.73, scanned page rendered at its native resolution (embedded image xref 283, 2526px across 8.31in), rendered at 92 dpi, capped to 700px wide, 701x743 WebP quality 70", "method": "mixed", "transcribed_by": "Codex with pypdf text extraction and visual page review", "reviewed": True},
			{"id": "excerpt.rfm.operations-switch-polarity", "locator": "PDF pages 37-38 and 87; printed pages 1-27 through 1-28 and 2-47", "path": MANUAL_POLARITY_EXCERPT, "sha256": MANUAL_POLARITY_EXCERPT_SHA256, "image": "evidence/excerpts/bally.revenge-from-mars.1999/operations-manual-switch-polarity.webp", "image_sha256": "6419cdd0413f202926272c67b1598d850eaf7400f765c2386621720093fa8e62", "image_derivation": "Bally_1999_Revenge_From_Mars_Operations_Manual_February_1999_OCR_searchable.pdf page 87, crop box 0.05,0.05,0.96,0.92, scanned page rendered at its native resolution (embedded image xref 280, 2519px across 8.29in), rendered at 93 dpi, capped to 700px wide, 701x948 WebP quality 70", "method": "mixed", "transcribed_by": "Codex with Poppler text extraction and visual page review", "reviewed": True},
