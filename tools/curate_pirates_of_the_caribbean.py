			...
			"excerpts": [
				{
					...
					"image": f"{EXCERPT_ROOT}/switch-matrix.webp",
					"image_sha256": "0683c143070e8a17d4a786ee594aec5f3f3d4fb28c0b269af48b382a9a59eb74",
					"image_derivation": "Stern_2006_Pirates_of_the_Caribbean_Pinball_Service_Game_Manual.pdf page 6, crop box 0.45,0.02,0.94,0.8, born-digital page rendered for legibility (smallest type in region 6.0pt, targeting 11px glyphs), rendered at 132 dpi, grayscale, rotated 90 degrees counter-clockwise, 1133x551 WebP quality 35",
					"method": "manual",
				...
				},
				{
					...
					"image": f"{EXCERPT_ROOT}/dedicated-switches.webp",
					"image_sha256": "790c2452b869d698680d880b0652b57f57547a35708c3b2b46f1940f6f040e4e",
					"image_derivation": "Stern_2006_Pirates_of_the_Caribbean_Pinball_Service_Game_Manual.pdf page 6, crop box 0.04,0.02,0.35,0.8, born-digital page rendered for legibility (smallest type in region 6.0pt, targeting 11px glyphs), rendered at 113 dpi, grayscale, rotated 90 degrees counter-clockwise, 972x299 WebP quality 50",
					"method": "manual",
					"transcribed_by": "curator, read from the 300 dpi rendered page",
					"reviewed": True,
				},
				{
					...
					"image": f"{EXCERPT_ROOT}/lamp-matrix.webp",
					"image_sha256": "39e3ee090d144e97a3134eb18c3501f9a3e6e13d36a23c5c030754b4b2131661",
					"image_derivation": "Stern_2006_Pirates_of_the_Caribbean_Pinball_Service_Game_Manual.pdf page 8, crop box 0.4,0.02,0.94,0.78, born-digital page rendered for legibility (smallest type in region 7.0pt, targeting 11px glyphs), rendered at 113 dpi, grayscale, rotated 90 degrees counter-clockwise, 947x521 WebP quality 50",
					"method": "manual",
					"transcribed_by": "curator, read from the 300 dpi rendered page",
					"reviewed": True,
				},
				{
					...
					"image": f"{EXCERPT_ROOT}/coils-detailed-chart.webp",
					"image_sha256": "c0026c7a60107fafa903451f1f4c48de196af542d1b3a23600c1cfd2a78b8ea0",
					"image_derivation": "Stern_2006_Pirates_of_the_Caribbean_Pinball_Service_Game_Manual.pdf page 10, crop box 0.08,0.08,0.9,0.74, born-digital page rendered for legibility (smallest type in region 6.0pt, targeting 11px glyphs), rendered at 129 dpi, capped to 900px wide, grayscale, 901x939 WebP quality 40",
					"method": "manual",
					"transcribed_by": "curator, read from the 300 dpi rendered page",
					"reviewed": True,
				},
