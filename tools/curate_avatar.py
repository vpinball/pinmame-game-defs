...
def sources(limited_edition: bool) -> list[dict[str, object]]:
	...
	result = [
		...
		{"id": VPX_TABLE_SOURCE, "kind": "vpx_table", "uri": "https://vpuniverse.com/files/file/4755-avatar-pro-real-mod-10-neo/", "sha256": "8ddff84ad8f5c8c6f583153f058458ed17bdd6fbafe60304fa2621920872590e", "locator": "Authenticated VPU exact Pro table archive; extracted Avatar (Stern 2010).vpx SHA-256 1838f6fc52c3599dd57382999a2ff7200e38cf741f658c479037b614c51d307a and embedded script SHA-256 0fa91c9232c2eca200c1598c759bd7b1dee742ccc63fb0de87105a062de4b4bd", "attribution": "VPU upload and table authors credited on the linked page"},
