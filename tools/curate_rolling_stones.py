...
def build(limited_edition: bool) -> dict[str, object]:
	...
	return {
		...
		"machine": {"id": machine_id, "name": name, "manufacturer": "Stern", "year": 2011, "kind": "physical_pinball", "ipdb_id": 5708 if limited_edition else 5668, "opdb_id": "GredR-Mb5jN" if limited_edition else "GredR-MDE2K"},
		...
		"displays": [{"id": "display.dmd", "label": "Dot-matrix display", "kind": "dmd", "width": 128, "height": 32, "spatial": {"status": "not_applicable", "reason": "cabinet_or_service", "provenance": provenance("validated", CORE_SOURCE, MANUAL_SOURCE)}, "provenance": provenance("validated", CORE_SOURCE, runtime_source)}],
