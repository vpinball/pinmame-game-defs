...
def main() -> None:
	write_json(ROOT / "machines/author-ready/stern/the-rolling-stones-standard-2011.json", build(False))
	write_json(ROOT / "machines/author-ready/stern/the-rolling-stones-limited-edition-2011.json", build(True))
	...
	write_text(ROOT / "knowledge/stern/the-rolling-stones-standard-2011.md", STANDARD_KNOWLEDGE)
	write_text(ROOT / "knowledge/stern/the-rolling-stones-limited-edition-2011.md", LE_KNOWLEDGE)
