		...
		},
		{
			...
			"excerpts": [
				...
				},
				{
					...
					"image": "evidence/excerpts/williams.fish-tales.1992/boards-and-assemblies.webp",
					"image_sha256": "f0e248fd508e50a9f5e13b73e24512c72cd94c1d34fb948df8ac32bb4181f456",
					"image_derivation": "Fish_Tales_OPS.pdf page 64, crop box 0.04,0.05,0.96,0.82, scanned page rendered at its native resolution (embedded image xref 267, 1304px across 8.69in), rendered at 90 dpi, capped to 700px wide, 701x759 WebP quality 70",
					"method": "manual",
					"transcribed_by": "curator, read from the rendered page",
					"reviewed": True,
				},
