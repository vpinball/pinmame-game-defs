...
def pro_extraction_report() -> dict[str, object]:
	return {'acquisition': {'exact_pro_extraction_performed': False,
	 ...
	 'machine_id': 'stern.tron-legacy-pro.2011',
...
def main() -> None:
	...
	write_json(ROOT / "reports/spatial/stern/tron-legacy-pro-2011.json", pro_extraction_report())
