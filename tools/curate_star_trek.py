...
STAR_TREK_PREMIUM_EXCERPTS = [
	{"id": "excerpt.star-trek-premium.switch-table", "locator": "Star-Trek-LE-Manual.pdf PDF page 68, crop box 0.05,0.06,0.95,0.92; complete switch matrix, dedicated switches, and DIP positions.", "path": "evidence/excerpts/stern.star-trek-premium-limited-edition.2013/switch-table.md", "sha256": "9a6f9558d763734cbc2dff148e54687c0d02f786e39ff9e0d5cd1a84229fe6be", "image": "evidence/excerpts/stern.star-trek-premium-limited-edition.2013/switch-table.webp", "image_sha256": "3303660129679699aa1147945bc0bcd4f7dfdb977ffb0b67dfae405cc0554b9c", "image_derivation": "Star-Trek-LE-Manual.pdf page 68, crop box 0.05,0.06,0.95,0.92, scanned page rendered at its native resolution (embedded image xref 307, 1053px across 10.97in), rendered at 71 dpi, capped to 700px wide, grayscale, 701x518 WebP quality 40", "method": "manual", "transcribed_by": "curator, read from the rendered source crop", "reviewed": True},
	{"id": "excerpt.star-trek-premium.board-inventory", "locator": "Star-Trek-LE-Manual.pdf PDF page 114, crop box 0.05,0.06,0.95,0.92; CPU/I/O board and boot-ROM inventory table.", "path": "evidence/excerpts/stern.star-trek-premium-limited-edition.2013/board-inventory.md", "sha256": "50591eb9220b1f9c63ca2a08a92c3fc915656341e63f55a77fc220adfbb32614", "image": "evidence/excerpts/stern.star-trek-premium-limited-edition.2013/board-inventory.webp", "image_sha256": "6f5251990147784e53830c325d0da45fc6a3a9f2ce702d833a399cd01b42a760", "image_derivation": "Star-Trek-LE-Manual.pdf page 114, crop box 0.05,0.06,0.95,0.92, scanned page rendered at its native resolution (embedded image xref 515, 815px across 8.49in), rendered at 92 dpi, capped to 700px wide, grayscale, 701x865 WebP quality 40", "method": "manual", "transcribed_by": "curator, read from the rendered source crop", "reviewed": True},
	{"id": "excerpt.star-trek-premium.opto-boards", "locator": "Star-Trek-LE-Manual.pdf PDF page 153, crop box 0.05,0.06,0.95,0.92; Pro/LE opto amplifier boards 1 and 2.", "path": "evidence/excerpts/stern.star-trek-premium-limited-edition.2013/opto-boards.md", "sha256": "0784cfcba615529345c4d19ce1e6bd055c27dab98c47d2ab4bc4a7ab8f8434e7", "image": "evidence/excerpts/stern.star-trek-premium-limited-edition.2013/opto-boards.webp", "image_sha256": "b88a56ab7665c037418fc071b6e1f33607eda5fb20e1e034a6461b86a7b84eb4", "image_derivation": "Star-Trek-LE-Manual.pdf page 153, crop box 0.05,0.06,0.95,0.92, scanned page rendered at its native resolution (embedded image xref 699, 815px across 8.49in), rendered at 92 dpi, capped to 700px wide, grayscale, 701x865 WebP quality 40", "method": "manual", "transcribed_by": "curator, read from the rendered source crop", "reviewed": True},
]

STAR_TREK_PRO_EXCERPTS = [
	{"id": "excerpt.star-trek-pro.switch-table", "locator": "Star-Trek-Pro-Manual.pdf PDF page 66, crop box 0.05,0.06,0.95,0.92; complete shared switch matrix, dedicated switches, and DIP positions.", "path": "evidence/excerpts/stern.star-trek-pro.2013/switch-table.md", "sha256": "17195c0c9d5955ad400f742058b58ca4772abfc5e0f5ce2f5694f7635f099d04", "image": "evidence/excerpts/stern.star-trek-pro.2013/switch-table.webp", "image_sha256": "3303660129679699aa1147945bc0bcd4f7dfdb977ffb0b67dfae405cc0554b9c", "image_derivation": "Star-Trek-Pro-Manual.pdf page 66, crop box 0.05,0.06,0.95,0.92, scanned page rendered at its native resolution (embedded image xref 299, 1053px across 10.97in), rendered at 71 dpi, capped to 700px wide, grayscale, 701x518 WebP quality 40", "method": "manual", "transcribed_by": "curator, read from the rendered source crop", "reviewed": True},
	{"id": "excerpt.star-trek-pro.coil-table", "locator": "Star-Trek-Pro-Manual.pdf PDF page 73, crop box 0.05,0.06,0.95,0.92; detailed Q1–Q32 coil chart.", "path": "evidence/excerpts/stern.star-trek-pro.2013/coil-table.md", "sha256": "d82efe007544ffff536fed1cbf9a13132e2c1bf44b9b8bb09d12f86973aaab0a", "image": "evidence/excerpts/stern.star-trek-pro.2013/coil-table.webp", "image_sha256": "9c7f289817bb8c5ca437a1947888a905d0fe4f30c9769497594eb405a96f0f3e", "image_derivation": "Star-Trek-Pro-Manual.pdf page 73, crop box 0.05,0.06,0.95,0.92, scanned page rendered at its native resolution (embedded image xref 329, 815px across 8.49in), rendered at 92 dpi, capped to 700px wide, grayscale, 701x865 WebP quality 40", "method": "manual", "transcribed_by": "curator, read from the rendered source crop", "reviewed": True},
	{"id": "excerpt.star-trek-pro.wiring-context", "locator": "Star-Trek-Pro-Manual.pdf PDF page 116, crop box 0.05,0.06,0.95,0.92; I/O board, CPU/sound board, and DMD connector overview.", "path": "evidence/excerpts/stern.star-trek-pro.2013/wiring-context.md", "sha256": "ecca494e23391cde3775eaa5e1a13da570ab2019967833b9443b818b7a7e4e07", "image": "evidence/excerpts/stern.star-trek-pro.2013/wiring-context.webp", "image_sha256": "1ac1986d0f2c7428dff3f03b05ccb16e47c04f20e663c9ee9a1f455865efb70e", "image_derivation": "Star-Trek-Pro-Manual.pdf page 116, crop box 0.05,0.06,0.95,0.92, scanned page rendered at its native resolution (embedded image xref 525, 1053px across 10.97in), rendered at 71 dpi, capped to 700px wide, grayscale, 701x518 WebP quality 40", "method": "manual", "transcribed_by": "curator, read from the rendered source crop", "reviewed": True},
]
...
def pro_mechanisms() -> list[dict[str, object]]:
	return [
		pro_mechanism("mechanism.trough", "Four-ball trough", "kicker", ["device.trough-up-kicker"], ["switch.trough-4-left", "switch.trough-3", "switch.trough-2", "switch.trough-1", "switch.trough-jam"], "The physical trough uses switches 18-21 from left to right plus jam opto 22 on the ejection path. The exact Pro table creates four balls on 18-21 and output 1 ejects the rightmost ball, but it does not model switch 22; the manual requires the downstream jam sensor.", runtime=True),
...
def sources(manual: str, premium: bool) -> list[dict[str, object]]:
	manual_record = {"id": manual, "kind": "manual", "uri": "https://sternpinball.com/support/game-code/", "sha256": "ca2007093bb4c1425d728a46e548d3af5a3d8fdd844c41dab48cd4ddbacb985d" if premium else "23cb9e6683d7b357ada48678a8e157a8b64102ea012821c350a3f033fae66b28", "locator": "Star-Trek-LE-Manual.pdf, PDF pages 68-77, 114-119, and 153-155" if premium else "Star-Trek-Pro-Manual.pdf: shared switch inventory on PDF page 66; pages 67 and 71 are LE/Premium location drawings and pages 68-70 are Premium/LE RGB lamp material excluded from the Pro inventory; main coil chart and shared Pro/LE physical coil map on pages 73-74; GI/DMD/switch wiring context on page 116 retained; LE-only auxiliary board page 117 and LE GI page 150 excluded; opto boards on pages 151-154, including LE-only switch 53 exclusion", "license": "NOASSERTION", "attribution": "Stern Pinball", "source_id": "stern", "original_filename": "Star-Trek-LE-Manual.pdf" if premium else "Star-Trek-Pro-Manual.pdf", "rights": "NOASSERTION", "acquired_at": "2026-08-02T00:00:00Z"}
	manual_record["excerpts"] = STAR_TREK_PREMIUM_EXCERPTS if premium else STAR_TREK_PRO_EXCERPTS
	result = [manual_record]
	if premium:
		result.append({"id": VPX_SOURCE, "kind": "vpx_script", "uri": "https://github.com/sverrewl/vpxtable_scripts/blob/0c036bb61b4b4e8c778c37559f6795df8cd1521e/special_audiopan_and_audiofade_patched/Star%20Trek%20LE%20%28Stern%202013%29%20v1.10.vbs", "revision": VPX_REVISION, "sha256": "3337481b28144a67f1df3c3650355be91699104930d8b3cc8503e14225a9d4ff", "locator": "Star Trek LE (Stern 2013) v1.10.vbs lines 438-470, 673-1080, 1490-1590, and 1900-2120", "license": "NOASSERTION", "attribution": "Table authors credited in the script and vpxtable_scripts contributors"})
	else:
		result.extend([
			{"id": PRO_VPX_SOURCE, "kind": "vpx_script", "uri": "local-evidence://vpx-script/star-trek-pro-fss", "sha256": "abc5dbb6ead12f16886143a50cfd2534c9baf855b070924dd7d82e404b4d69bf", "locator": "Star Trek Pro (Stern 2013)-[D&N][FSS][DMD].vbs extracted from the archived table; game st_161, initialization, switch handlers, solenoid callbacks, lamp timer, explicit GILighting collection behavior, and mechanism behavior", "license": "NOASSERTION", "attribution": "Table authors credited by the archived table", "original_filename": "Star Trek Pro (Stern 2013)-[D&N][FSS][DMD].vbs", "known_working": True},
			{"id": PRO_VPX_TABLE_SOURCE, "kind": "vpx_table", "uri": "https://archive.org/details/Visual_Pinball_2020-06-20", "sha256": "2976e3313a6fa1ee6f26709d515661b81ade8f01894a847b907a5e608e5bb9e7", "locator": "Visual Pinball [VPXx] PinMame Tables [Full Single Screen]/Star Trek Pro (Stern 2013)-[D_N][FSS][DMD].zip; archive SHA-256 eaa577d4514b4945f6d98195a161c3de59d67c61f2b4d75e4c99169c9b6c1a34; exact 952 by 2300 game-item geometry, collections, and physical lamp objects extracted read-only with vpxtool git:v0.33.3", "license": "NOASSERTION", "attribution": "Table authors credited by the archived table", "original_filename": "Star Trek Pro (Stern 2013)-[D&N][FSS][DMD].vpx", "known_working": True},
