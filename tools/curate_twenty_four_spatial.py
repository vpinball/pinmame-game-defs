...
def _partialize(definition: dict[str, object]) -> None:
	...
	definition["conflicts"] = [
		...
		},
		{
			...
			"description": "The ROM diagnostics establish switch labels and state behavior, and Stern page 43 identifies two suitcase microswitch part types, but the available official material does not establish factory contact construction, normal state, and mounting/seat for every used playfield contact. Used matrix records therefore retain switch_type unknown.",
		...
		},
		{
			...
			"description": "The exact VPX exposes Drain and BallRelease but no SW18-SW22 contact objects. The ordered five-point projection preserves controller order and shared-assembly geometry with about +/-0.03 normalized practical uncertainty, but not physical seat coordinates or contact/optic construction.",
		...
		},
		{
			...
			"description": "The ROM diagnostic groups lamps 72-75 as CTU and 76-78 as MOLE without establishing individual face order; the exact script's Q27 description contains the tentative 'under jet?' wording. Bindings and coordinates are retained, but physical naming is not fully authoritative.",
