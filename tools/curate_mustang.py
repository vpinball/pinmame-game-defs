...
MUSTANG_PREMIUM_EXCERPTS = [
	{"id": "excerpt.mustang-premium.switch-matrix", "locator": "Mustang_LE_web.pdf PDF page 8, crop box 0.06,0.10,0.96,0.54; complete four-row switch matrix.", "path": "evidence/excerpts/stern.mustang-premium-limited-edition-boss.2014/switch-matrix.md", "sha256": "759fc11d97e0f82d9893142195f30344be20b80249d09ebc1c0dafbe5857c73c", "image": "evidence/excerpts/stern.mustang-premium-limited-edition-boss.2014/switch-matrix.webp", "image_sha256": "55b0f423b19878b04e48aef60e82fb6b868316f4a3087ca6691b26ca422df1c7", "image_derivation": "Mustang_LE_web.pdf page 8, crop box 0.06,0.1,0.96,0.54, scanned page rendered at its native resolution (embedded image xref 32, 6592px across 10.99in), rendered at 86 dpi, capped to 850px wide, grayscale, 851x320 WebP quality 45", "method": "manual", "transcribed_by": "curator, read from the rendered source crop", "reviewed": True},
	{"id": "excerpt.mustang-premium.lamp-matrix", "locator": "Mustang_LE_web.pdf PDF page 10, crop box 0.06,0.08,0.96,0.54; visible lamp matrix rows Q33–Q37.", "path": "evidence/excerpts/stern.mustang-premium-limited-edition-boss.2014/lamp-matrix.md", "sha256": "10cb962a39a810f6c9bbbf6a21b95a1cc1ad86575c1e072319a27d955b57326e", "image": "evidence/excerpts/stern.mustang-premium-limited-edition-boss.2014/lamp-matrix.webp", "image_sha256": "ff31f026c034ca049a9c4af290f672de959c15d5b9bc2cc59d7f9cf895831c9b", "image_derivation": "Mustang_LE_web.pdf page 10, crop box 0.06,0.08,0.96,0.54, scanned page rendered at its native resolution (embedded image xref 42, 6592px across 10.99in), rendered at 86 dpi, capped to 850px wide, grayscale, 851x335 WebP quality 45", "method": "manual", "transcribed_by": "curator, read from the rendered source crop", "reviewed": True},
	{"id": "excerpt.mustang-premium.coil-wiring", "locator": "Mustang_LE_web.pdf PDF page 16, crop box 0.61,0.45,0.98,0.92; typical single-coil and dual-winding coil wiring.", "path": "evidence/excerpts/stern.mustang-premium-limited-edition-boss.2014/coil-map.md", "sha256": "93c75387d2e051a570adc8db973e572be623e4df5e1fa1394ac8c663fa72f5d8", "image": "evidence/excerpts/stern.mustang-premium-limited-edition-boss.2014/coil-map.webp", "image_sha256": "81d0c9d9f495829b55ff5de5c92af3bef93d01b01fabc47ae6ec543868abddcb", "image_derivation": "Mustang_LE_web.pdf page 16, crop box 0.61,0.45,0.98,0.92, scanned page rendered at its native resolution (embedded image xref 69, 5056px across 8.43in), rendered at 225 dpi, capped to 700px wide, grayscale, 701x1161 WebP quality 45", "method": "manual", "transcribed_by": "curator, read from the rendered source crop", "reviewed": True},
]

MUSTANG_PRO_EXCERPTS = [
	{"id": "excerpt.mustang-pro.switch-matrix", "locator": "Mustang-Manual.pdf PDF page 12, crop box 0.05,0.08,0.96,0.88, rotated 90° counter-clockwise; switch matrix, dedicated switches, and DIP row.", "path": "evidence/excerpts/stern.mustang-pro.2014/switch-matrix.md", "sha256": "5ddec5965596d392dfb6dbd1d428805ccecb5b089c137185f15235f109a30189", "image": "evidence/excerpts/stern.mustang-pro.2014/switch-matrix.webp", "image_sha256": "0e134377c232880222ca9685125042a9bed8206f1c5a3c1a3ec4f71aab60f170", "image_derivation": "Mustang-Manual.pdf page 12, crop box 0.05,0.08,0.96,0.88, scanned page rendered at its native resolution (embedded image xref 55, 610px across 8.48in), rendered at 72 dpi, grayscale, rotated 90 degrees counter-clockwise, 631x556 WebP quality 40", "method": "manual", "transcribed_by": "curator, read from the rendered source crop", "reviewed": True},
]
...
def sources(manual: str, premium: bool) -> list[dict[str, object]]:
	...
	manual_record["excerpts"] = MUSTANG_PREMIUM_EXCERPTS if premium else MUSTANG_PRO_EXCERPTS
	result = [manual_record]
	if premium:
		result.extend([
			{"id": VPX_SOURCE, "kind": "vpx_script", "uri": "https://github.com/sverrewl/vpxtable_scripts/blob/0c036bb61b4b4e8c778c37559f6795df8cd1521e/special_audiopan_and_audiofade_patched/Mustang%20%28Stern%202014%29%20v1.27.vbs", "revision": VPX_REVISION, "sha256": "092611fc754374d11d032b81b63638b5a2dc2f43464ee6c7c3cd27874c77e5c3", "locator": "Mustang (Stern 2014) v1.27.vbs lines 138, 204-300, 420-780, 850-930, 1280-1445, and lamp update routines", "license": "NOASSERTION", "attribution": "VPW contributors, prior table authors, and vpxtable_scripts contributors"},
