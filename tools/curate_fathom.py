...
def source_records() -> list[dict[str, Any]]:
	...
	return [
		...
		},
		{
			...
			"excerpts": [
				excerpt(
					"excerpt.fathom.self-test-tables",
					"PDF page 23, printed page 17: SOLENOID IDENTIFICATION TABLE and SWITCH ASSEMBLY SELF-TEST DISPLAY NUMBERS, both transcribed in full including the three blank switch rows",
					"self-test-tables.md",
					"cda246eed6dfa8d71b71ec59f70832680f29fb438ca8a638baf160f98edaba84",
				),
				excerpt(
		...
		},
		{
			...
			"excerpts": [
				excerpt(
					"excerpt.fathom.solenoid-driver-a3",
					"PDF page 7, SOLENOID DRIVER VOLTAGE REGULATOR SCHEMATIC W-1183-34c: the 74L154 momentary decode, all fifteen driver stages, the four continuous outputs and every connector destination label",
					"solenoid-driver-a3.md",
					"c62783a5b8299ab3868bd30d813e843650ff375bb2437e1cc8b5ce73ee1c1fbc",
				),
				excerpt(
					"excerpt.fathom.lamp-driver-a5",
					"PDF page 8, A5 LAMP DRIVER SCHEMATIC W-1182-34c: the four MC14514CP decoders, all sixty output-to-SCR pairs and the complete J1/J2/J3 printed pin function lists",
					"lamp-driver-a5.md",
					"9b7ab72dece71b4b8dddae414cc2bf323c92a24b1c22aef8f9ac60ded07235d4",
				),
				excerpt(
					"excerpt.fathom.playfield-wiring",
					"PDF page 11, WIRING DIAGRAM PLAYFIELD W-1192-30: switch-matrix strobe and return wiring, solenoid coil wires and connectors, general illumination, and the A5J1/A5J2/A5J3 lamp harness lists",
					"playfield-wiring.md",
					"760e6805942d5d6f71cd25de69bc5c3347a7f5c164ff3c66e3ddafd6750a37f6",
				),
				{
