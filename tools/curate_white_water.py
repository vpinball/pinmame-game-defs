		...
		},
		{
			...
			"excerpts": [
				...
				},
				{
					...
					"image": "evidence/excerpts/williams.white-water.1993/bigfoot-test.webp",
					"image_sha256": "c7ea1fdd50959904a92d88c493d31ab44b18d7840c71f665354838baafd06093",
					"image_derivation": "Williams_1993_White_Water_English_Manual.pdf page 36, crop box 0.04,0.05,0.96,0.83, scanned page rendered at its native resolution (embedded image xref 142, 5100px across 8.50in), rendered at 90 dpi, capped to 700px wide, 1001x768 WebP quality 70",
					"method": "manual",
