...
MANUAL_IMAGE_ROOT = "evidence/excerpts/stern.ali.1980"
...
SOURCES: list[dict[str, object]] = [
	...
	{"id": MANUAL_SOURCE, "kind": "manual", "uri": "https://www.pinballrebel.com/pinball/cards/Tech_Charts/Stern_Ali_Tech_Chart.pdf", "sha256": "455ea85f99eff031ffcca75489ab4dfea0a587a864522fb2fa30a4bfd160d78b", "locator": "Stern_Ali_Tech_Chart.pdf page 1: switch matrix, controlled-lamp chart, coil table, flipper circuits, boards, and fuses; rendered excerpts are derived from bytes matching this pinned SHA-256", "license": "NOASSERTION", "attribution": "Inkochnito; hosted by Pinball Rebel", "source_id": "pinballrebel", "original_filename": "Stern_Ali_Tech_Chart.pdf", "rights": "NOASSERTION",
	 "excerpts": [
		{"id": "excerpt.ali.manual-coil-table", "locator": "PDF page 1, complete Coil Table and Flipper Circuits", "path": f"{MANUAL_IMAGE_ROOT}/manual-coil-table.md", "sha256": "e0266cf5a9f230b139449c88c00fac0f979c072279ba4798c845cc20dc56a440", "method": "manual", "transcribed_by": "curator, read from the retained rendered page", "reviewed": True, "image": f"{MANUAL_IMAGE_ROOT}/manual-coil-table.webp", "image_sha256": "3e29c180ff928cbc62dcfbeb7ad15b3b7e4932f2efc0c20213cc1a09ebb05fd5", "image_derivation": "Stern_Ali_Tech_Chart.pdf page 1, crop box 0.55,0.06,0.99,0.42, born-digital page rendered for legibility (smallest type in region 7.0pt, targeting 11px glyphs), rendered at 114 dpi, grayscale, 853x451 WebP quality 55"},
		{"id": "excerpt.ali.manual-switch-matrix", "locator": "PDF page 1, complete five-strobe by eight-return Switch Matrix", "path": f"{MANUAL_IMAGE_ROOT}/manual-switch-matrix.md", "sha256": "b3af3503e2118757377c643529639c469f65da1b2fb944cf5e4ea1f5f8d2281b", "method": "manual", "transcribed_by": "curator, read from the retained rendered page", "reviewed": True, "image": f"{MANUAL_IMAGE_ROOT}/manual-switch-matrix.webp", "image_sha256": "4c3caa449fc268947fdfc9439c3a936314208ccdfa3dcc99a6fb8e550cc0702e", "image_derivation": "Stern_Ali_Tech_Chart.pdf page 1, crop box 0.55,0.47,0.99,0.95, born-digital page rendered for legibility (smallest type in region 6.0pt, targeting 11px glyphs), rendered at 132 dpi, grayscale, 988x698 WebP quality 55"},
		{"id": "excerpt.ali.manual-controlled-lamps", "locator": "PDF page 1, complete Controlled Lamps Chart", "path": f"{MANUAL_IMAGE_ROOT}/manual-controlled-lamps.md", "sha256": "b895471666faeb022bb2b98dc193ebd42978ba7326888ae67e0b74c0e0bfa0f2", "method": "manual", "transcribed_by": "curator, read from the retained rendered page", "reviewed": True, "image": f"{MANUAL_IMAGE_ROOT}/manual-controlled-lamps.webp", "image_sha256": "3315563a729048e34c3e14272fb870135cd55e6df21ef6f821fe4c3c5ad61650", "image_derivation": "Stern_Ali_Tech_Chart.pdf page 1, crop box 0.06,0.47,0.46,0.95, born-digital page rendered for legibility (smallest type in region 5.0pt, targeting 11px glyphs), rendered at 147 dpi, capped to 1000px wide, grayscale, 1000x777 WebP quality 55"},
	 ]},
...
- `manual.ali.tech-chart`: organized external `Stern_Ali_Tech_Chart.pdf`, SHA-256 `455ea85f99eff031ffcca75489ab4dfea0a587a864522fb2fa30a4bfd160d78b`; one-page switch, lamp, coil, flipper, board, and fuse chart with committed image excerpts for its key tables.
