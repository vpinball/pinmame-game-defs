...
def manual_excerpts() -> list[dict[str, Any]]:
	"""Return the reviewed proof crops derived from the exact ARC ARC manual bytes."""
	evidence_root = "evidence/excerpts/williams.terminator-2-judgment-day.1991"
	records = (
		("excerpt.t2.switch-matrix", "PDF page 46, printed page 1-26, Switch Matrix wiring table", "switch-matrix.md", "9c81830621e03aa9e7e943879ca0aca219e74d9c7dea6f3675a20c2f42c3cd5d", "switch-matrix.webp", "8304c477a8f4eacf1aba998a4fe92ac7a77b0bc83f9ae1fc8cad674ca4686875", "Terminator 2 Judgement Day Operations Manual.pdf page 46, crop box 0.15,0.09,0.88,0.48, scanned page rendered at its native resolution (embedded image xref 405, 2551px across 8.26in), rendered at 166 dpi, capped to 1000px wide, grayscale, 1001x757 WebP quality 75"),
		("excerpt.t2.solenoid-table-01-08", "PDF page 48, printed page 1-28, Solenoid Table rows 1-8", "solenoid-and-gi-table.md", "2e50c90430e49c2c7e183478abf7bee1e1a3a0869deda29c2e0383fdeaa90e91", "solenoid-table-01-08.webp", "e45beaccfecb8c8bafaad73e2c8c3a1d2bc23c3c1ab505580caf7a40a81ec769", "Terminator 2 Judgement Day Operations Manual.pdf page 48, crop box 0.13,0.11,0.9,0.35, scanned page rendered at its native resolution (embedded image xref 423, 2551px across 8.26in), rendered at 157 dpi, capped to 1000px wide, grayscale, 1001x442 WebP quality 75"),
		("excerpt.t2.solenoid-table-09-16", "PDF page 48, printed page 1-28, Solenoid Table rows 9-16", "solenoid-and-gi-table.md", "2e50c90430e49c2c7e183478abf7bee1e1a3a0869deda29c2e0383fdeaa90e91", "solenoid-table-09-16.webp", "fbd2d495b2b46bd483309e38e09428466b5f99f2be8633d91f8a7bc01884abc8", "Terminator 2 Judgement Day Operations Manual.pdf page 48, crop box 0.13,0.33,0.9,0.47, scanned page rendered at its native resolution (embedded image xref 423, 2551px across 8.26in), rendered at 157 dpi, capped to 1000px wide, grayscale, 1001x258 WebP quality 75"),
		("excerpt.t2.solenoid-table-flashers-gi", "PDF page 48, printed page 1-28, Solenoid Table rows 17-28, GI, and lower flippers", "solenoid-and-gi-table.md", "2e50c90430e49c2c7e183478abf7bee1e1a3a0869deda29c2e0383fdeaa90e91", "solenoid-table-flashers-gi.webp", "fc62aae625f1ba34e5087f9437b3c35909f9b186d22a94901e7cb2698a33160c", "Terminator 2 Judgement Day Operations Manual.pdf page 48, crop box 0.13,0.42,0.9,0.76, scanned page rendered at its native resolution (embedded image xref 423, 2551px across 8.26in), rendered at 157 dpi, capped to 1000px wide, grayscale, 1001x626 WebP quality 75"),
		("excerpt.t2.lamp-matrix", "PDF page 53, printed page 1-33, Lamp Matrix table and circuit header", "lamp-matrix.md", "7f8d67287f26548190ee3d953426a2cd6a6ec0bbbf8fdb95976d2151e910b03a", "lamp-matrix.webp", "1748b20212ac4eb29f52df64b1d04474301d16b6957d61edb9cf35841a045e20", "Terminator 2 Judgement Day Operations Manual.pdf page 53, crop box 0.2,0.09,0.84,0.73, scanned page rendered at its native resolution (embedded image xref 468, 2551px across 8.26in), rendered at 151 dpi, capped to 800px wide, grayscale, 800x1133 WebP quality 75"),
		("excerpt.t2.major-mechanisms-map", "PDF page 70, printed page 2-4, Locations Diagram - Game Major Mechanisms", "major-mechanisms-map.md", "bbdc51d23a9e5143a37be92319f566f5792ab741f133eac907de834fa6ec566e", "major-mechanisms-map.webp", "2c0c0a9434ee7cdc0414ed66fe40a7e7d79b460fad7e1be7eb95f9bd5035999a", "Terminator 2 Judgement Day Operations Manual.pdf page 70, crop box 0.05,0.03,0.92,0.84, scanned page rendered at its native resolution (embedded image xref 621, 2551px across 8.26in), rendered at 139 dpi, capped to 1000px wide, grayscale, 1001x1319 WebP quality 70"),
		("excerpt.t2.cannon-platform-assembly", "PDF page 90, printed page 2-24, A-14504 Platform Gun Assembly", "cannon-platform-assembly.md", "b20bc68978416c288342b9215e367c30a1c922fb66082eaefc785abc510bfa50", "cannon-platform-assembly.webp", "681630fcd4d00357057db4bffa645919217d5ee154968f4e05a465a327f4e5f7", "Terminator 2 Judgement Day Operations Manual.pdf page 90, crop box 0.05,0.07,0.95,0.93, scanned page rendered at its native resolution (embedded image xref 801, 2551px across 8.26in), rendered at 121 dpi, capped to 900px wide, grayscale, rotated 270 degrees counter-clockwise, 1218x900 WebP quality 70"),
	)
	return [
		{
			"id": identifier, "locator": locator, "path": f"{evidence_root}/{markdown}", "sha256": markdown_sha256,
			"image": f"{evidence_root}/{image}", "image_sha256": image_sha256,
			"image_derivation": image_derivation,
			"method": "manual", "reviewed": True, "transcribed_by": "curator, manually read and visually checked against the retained crop",
		}
		for identifier, locator, markdown, markdown_sha256, image, image_sha256, image_derivation in records
	]
...
def source_records() -> list[dict[str, Any]]:
	return [
		...
		{"id": MANUAL_SOURCE, "kind": "manual", "uri": "external:pinmame-manuals/by-machine/williams.terminator-2-judgment-day.1991/arcarc/Terminator%202%20Judgement%20Day%20Operations%20Manual.pdf", "original_filename": "Terminator 2 Judgement Day Operations Manual.pdf", "sha256": MANUAL_SHA256, "locator": "ARC ARC manifest ID other.arcarc.williams.terminator-2-judgment-day.1991.8540d654b39c; retained 118-page image-only Williams operations manual. The attached crops were rendered directly from exact 8540d654… bytes: switch matrix p.46, solenoid/GI table p.48, lamp matrix p.53, major-mechanism map p.70, and A-14504 platform-gun assembly p.90.", "excerpts": manual_excerpts(), "license": "NOASSERTION", "attribution": "Williams Electronics"},
		...
		{"id": G5K_SCRIPT_SOURCE, "kind": "vpx_script", "uri": "https://github.com/sverrewl/vpxtable_scripts/blob/0c036bb61b4b4e8c778c37559f6795df8cd1521e/Terminator%202%20%28Williams%201991%29%20g5k%20v1.1a.vbs", "revision": "0c036bb61b4b4e8c778c37559f6795df8cd1521e", "sha256": "f6c3d5ec0aa95bb6c3ac3160b35adff9a6b1c6d282e64e15a3709f426f08949a", "known_working": False, "locator": "Corroborating g5k script inventory; consulted where it agrees with the retained VPW script, never promoted over it", "license": "NOASSERTION", "attribution": "g5k table authors"},
		{"id": MODERN_SCRIPT_SOURCE, "kind": "vpx_script", "uri": "https://github.com/sverrewl/vpxtable_scripts/blob/0c036bb61b4b4e8c778c37559f6795df8cd1521e/Terminator%202%20%28Williams%201991%29.vbs", "revision": "0c036bb61b4b4e8c778c37559f6795df8cd1521e", "sha256": "1bbcc5873a1db87fe59d1daefbb69b68872cf58f029320a9d7d9410db7c59d97", "known_working": False, "locator": "Comparison-only modern script; its four-position trough, pulsed 62/64, virtual devices, and keyframed/magnet cannon are excluded from this physical VPW definition", "license": "NOASSERTION", "attribution": "Modern community table authors"},
...
def conflicts() -> list[dict[str, Any]]:
	return [
		{"id": "conflict.solenoid-12-physical-presence", "path": "outputs.pinmame.output.solenoid.12", "description": "The early manual coil/location list identifies solenoid 12 as Knock Down / SM1-26-600, while the later manual electrical table says Not Used. The retained VPW script has no SolCallback(12). The definition retains the channel as optional and does not manufacture a resolution. Resolution path: a photograph or continuity check of the printed Brn-Yel / J127-5 / Q52 branch on an unrestored production machine, showing whether an SM1-26-600 coil is fitted on it at all; separately, a LibPinMAME harness trace of the solenoid test against the retained legal t2_l8 ROM shows whether the ROM drives public 12, which bounds the question from the emulator side without settling fitment. Unresolved.", "source_refs": [MANUAL_SOURCE, CORE_SOURCE]},
		{"id": "conflict.lamp-schematic-connector-labels", "path": "outputs.pinmame.output.lamp", "description": "The later lamp schematic connector labels do not match the matrix table labels one-for-one. Matrix address/name identity is preserved from the printed matrix table; connector labels are not synthesized into wiring fields. Resolution path: re-render the disagreeing lamp schematic sheet of the retained image-only 118-page manual at a higher dpi and reconcile it address by address against the printed lamp-matrix table, or obtain a second printed copy or revision of the manual; where the two still disagree, only a per-address continuity check from the lamp-driver row and column pins to each socket on an unrestored machine, or a photograph of that playfield's insert legends, can say which sheet describes the machine. Unresolved.", "source_refs": [MANUAL_SOURCE, MANUAL_SUPPORT_SOURCE, CORE_SOURCE]},
		{"id": "conflict.gi-string-routing", "path": "outputs.pinmame.output.gi", "description": "The manual names five GI strings (GI 1 Top Insert, GI 2 Left Playfield, GI 3 Right Playfield, GI 4 Not Used, GI 5 Bottom Insert), while the retained VPW script exposes GI2/GI3 emitter arrays and a separate Case 3 Light2-Light5 branch; legacy mapping names also differ. Physical five-channel routing and script callback grouping remain explicit, unresolved evidence rather than an averaged map. Resolution path: run the machine's own general-illumination test on an unrestored production unit and photograph which region lights at each of the five steps, matching each step to the printed drives Wht-Brn/J120-7/Q18, Wht-Vio/J119-1/Q10, Wht-Yel/J121-9/Q14, Wht-Orn/J120-8/Q16 and Wht-Grn/J120-10/Q12; that also settles whether the printed GI 4 string, which carries a connector and transistor but no printed bulb part, is fitted at all. A LibPinMAME harness trace against the retained legal t2_l8 ROM supplies the emulator half of the pairing but cannot say where the bulbs sit. Unresolved.", "source_refs": [MANUAL_SOURCE, VPX_SCRIPT_SOURCE, CONTROLLER_SOURCE]},
		{"id": "conflict.flashing-channel-24", "path": "outputs.pinmame.output.solenoid.24", "description": "The manual lists a Backglass Flashlamp at solenoid 24, but the retained script has no SolCallback(24). Physical inventory and emulator address are retained without inventing a callback or playfield emitter. Resolution path: a photograph of an unrestored backbox showing whether a #906 bulb is fitted on the printed Blu-Gry / J125-7 / Q32 branch, together with a LibPinMAME harness trace of the flasher test against the retained legal t2_l8 ROM confirming that the ROM drives public 24; the retained table's silence is a gap in that table and settles nothing about the machine either way. Unresolved.", "source_refs": [MANUAL_SOURCE, VPX_SCRIPT_SOURCE]},
	]
