...
PAGE_SCALE_DRAWINGS = {
	...
	"excerpt.big-bang-bar.lamp-matrix-a-x2-quantities",
	"excerpt.big-bang-bar.lamp-matrix-b-x2-quantities",
	"excerpt.big-bang-bar.solenoid-location-diagram",
	...
	"excerpt.elvira.cabinet-wiring",
	"excerpt.elvira.lamp-locations",
	"excerpt.elvira.solenoid-flasher-locations",
	"excerpt.elvira.switch-locations",
	"excerpt.johnny-mnemonic.cyber-space-assembly",
	"excerpt.johnny-mnemonic.diverter-assembly",
	"excerpt.johnny-mnemonic.hand-motors-circuit",
	"excerpt.johnny-mnemonic.hand-popper-assembly",
	"excerpt.johnny-mnemonic.solenoid-flasher-locations-drawing",
	"excerpt.johnny-mnemonic.switch-locations-drawing",
	"excerpt.fathom.playfield-wiring",
	"excerpt.firepower.cabinet-wiring",
	"excerpt.firepower.insert-board-wiring",
	"excerpt.firepower.playfield-lamp-wiring",
	"excerpt.firepower.playfield-solenoid-wiring",
	"excerpt.firepower.playfield-switch-wiring",
	"excerpt.firepower.power-wiring",
	"excerpt.firepower.switch-locations",
	...
	"excerpt.sttng.borg-bracket-assembly",
	"excerpt.sttng.flasher-locations-drawing",
	"excerpt.sttng.gun-assembly",
	"excerpt.sttng.lamp-locations-drawing",
