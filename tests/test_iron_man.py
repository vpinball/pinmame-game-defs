...
class IronManDefinitionTests(unittest.TestCase):
	...
	def test_physical_products_are_split_and_both_reviewed_products_are_author_ready(self) -> None:
		...
		self.assertEqual({"id": "stern.iron-man.2010", "ipdb_id": 5550, "kind": "physical_pinball", "manufacturer": "Stern", "model_number": "I-00B3", "name": "Iron Man", "opdb_id": "GRVq4-MLyxq", "year": 2010}, self.original["machine"])
		self.assertEqual({"id": "stern.iron-man-vault-edition.2014", "ipdb_id": 6154, "kind": "physical_pinball", "manufacturer": "Stern", "model_number": "I-00B0", "name": "Iron Man Pro Vault Edition", "opdb_id": "GRVq4-M4oNp", "year": 2014}, self.vault["machine"])
