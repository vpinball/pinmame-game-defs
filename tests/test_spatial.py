...
class SpatialMigrationTests(unittest.TestCase):
	...
	def test_pending_spatial_retrofits_are_conspicuous_v2_partials_and_reports_reconcile(self) -> None:
		...
		# spatial gap.
		# Stern The Lord of the Rings raises it to 28. It replaces a legacy candidate-only
		# partial in place, so the partial/stub/author-ready totals above are unchanged by it;
		# the nineteen LEDs of board 520-5242-00 at public lamps 81-99 have no spatial key at
		# all, because the shared Whitestar profile caps pinmame.output.lamp at 1-80 and they
		# cannot be enumerated in the first place.
