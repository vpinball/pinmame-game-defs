...
class SpatialMigrationTests(unittest.TestCase):
	...
	def test_pending_spatial_retrofits_are_conspicuous_v2_partials_and_reports_reconcile(self) -> None:
		...
		self.assertEqual(674, report["stub_count"])
		...
		self.assertEqual(35, report["missing_requirement_counts"]["spatial_placement"])
		...
		self.assertEqual(674, catalog["summary"]["stub_count"])
