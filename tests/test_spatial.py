...
class SpatialMigrationTests(unittest.TestCase):
	...
	def test_pending_spatial_retrofits_are_conspicuous_v2_partials_and_reports_reconcile(self) -> None:
		...
		self.assertEqual(679, report["stub_count"])
		...
		# spatial gap.
		# Stern The Lord of the Rings raises it to 25. It also replaces a legacy candidate-only
		...
		self.assertEqual(679, catalog["summary"]["stub_count"])
