...
class SpatialMigrationTests(unittest.TestCase):
	...
	def test_pending_spatial_retrofits_are_conspicuous_v2_partials_and_reports_reconcile(self) -> None:
		...
		self.assertEqual(1, len(list((ROOT / "machines" / "author-ready").rglob("*.json"))))
		...
		self.assertEqual(1, report["author_ready_count"])
		self.assertEqual(101, report["partial_count"])
		...
		self.assertEqual(32, report["missing_requirement_counts"]["spatial_placement"])
