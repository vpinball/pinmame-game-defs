...
class SpatialMigrationTests(unittest.TestCase):
	...
	def test_pending_spatial_retrofits_are_conspicuous_v2_partials_and_reports_reconcile(self) -> None:
		...
		self.assertEqual(20, len(migrated))
		...
		self.assertEqual(13, len(list((ROOT / "machines" / "author-ready").rglob("*.json"))))
		...
		self.assertEqual(13, report["author_ready_count"])
		...
		self.assertEqual(13, catalog["summary"]["author_ready_count"])
		...
		self.assertEqual(20, len(note_paths))
