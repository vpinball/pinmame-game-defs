# Dark Shadow (Nuova Bell Games 1986)

Coverage: **partial - machine identity only. Nothing about playfield devices, wiring, mechanisms,
or behavior is evidenced yet.**

This record was promoted from the generated catalog stub `stub.pinmame.darkshad` by the
...
- PinMAME catalog: root driver `darkshad`, description "Dark Shadow", manufacturer
...
- The definition's driver list is exactly the clone tree PinMAME declares under `darkshad`;
