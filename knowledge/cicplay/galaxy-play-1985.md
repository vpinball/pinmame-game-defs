# Galaxy Play (CICPlay 1985)

Coverage: **partial - machine identity only. Nothing about playfield devices, wiring, mechanisms,
or behavior is evidenced yet.**

This record was promoted from the generated catalog stub `stub.pinmame.glxplay` by the
...
- PinMAME catalog: root driver `glxplay`, description "Galaxy Play", manufacturer
  "CICPlay", catalog year "1985".
...
- The definition's driver list is exactly the clone tree PinMAME declares under `glxplay`;
  whether every listed driver really runs on this physical machine is unverified.

## Drivers this record holds

- `glxplay` (1985, CICPlay).
