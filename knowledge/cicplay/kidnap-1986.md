...
This record was promoted from the generated catalog stub `stub.pinmame.kidnap` by the
...
- PinMAME catalog: root driver `kidnap`, description "Kidnap", manufacturer
  "CICPlay", catalog year "1986".
...
- The definition's driver list is exactly the clone tree PinMAME declares under `kidnap`;
