# Wolf Man (Peyper (Spain) 1987)

Coverage: **partial - machine identity only. Nothing about playfield devices, wiring, mechanisms,
or behavior is evidenced yet.**

This record was promoted from the generated catalog stub `stub.pinmame.wolfman` by the
...
- PinMAME catalog: root driver `wolfman`, description "Wolf Man", manufacturer
...
- The definition's driver list is exactly the clone tree PinMAME declares under `wolfman`;
  whether every listed driver really runs on this physical machine is unverified.

## Drivers this record holds

- `wolfman` (1987, Peyper (Spain)).
