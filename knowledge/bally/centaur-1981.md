...
- `games/centaur.json#/coils/12`: Duplicate binding label candidate `Right 4 Drop Target "4" (bottom)` differs from `Right 4 Drop Target "3"`.
...
- `legacy.game.centaur`: `games/centaur.json` at the pinned migration revision.
