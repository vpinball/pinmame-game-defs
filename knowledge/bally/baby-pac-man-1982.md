...
This record was promoted from the generated catalog stub `stub.pinmame.babypac` by the
...
- `babypac` (1982, Bally).
- `babypaca` (1983, Bally, clone of `babypac`).
- `babypacn` (2006, Bally / Oliver, clone of `babypac`).
