...
- The pinned PinMAME source declares `evelknie` at `src/wpc/by35games.c:115` with machine module `by35_mBY17`; the definition declares controller platform `pinmame.by35` from it.
