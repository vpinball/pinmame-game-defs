...
- The pinned PinMAME source declares `playboy` at `src/wpc/by35games.c:390` with machine module `by35_mBY35_32S`; the definition declares controller platform `pinmame.by35` from it.
