...
- The pinned PinMAME source declares `stk_sprs` at `src/wpc/by35games.c:245` with machine module `by35_mBY17`; no reviewed profile covers that module yet, so no platform is declared.
