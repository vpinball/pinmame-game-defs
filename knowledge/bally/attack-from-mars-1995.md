...
Legacy evidence identifies this candidate as Bally (1995). The information below is preserved for recreation work but is not automatically treated as validated physical-machine fact.
...
- `legacy.game.afm`: `games/afm.json` at the pinned migration revision.
