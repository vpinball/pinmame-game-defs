...
- The pinned PinMAME source declares `gi_l9` at `src/wpc/sims/wpc/full/gi.c:481` with machine module `wpc_mDMDS`; no platform is declared (no reviewed profile covers that module yet).
