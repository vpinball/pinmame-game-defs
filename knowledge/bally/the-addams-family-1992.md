...
This is the Bally/Midway physical product released January 1992, IPDB #20, WPC part-number family 16-20017 (Operations Manual 16-20017-101, Operator's Handbook 16-20017-103, WPC Schematic Manual 16-20017-102A). It covers the `taf_*` clone tree rooted at `taf_l5`: 21 driver rows spanning Bally production revisions L-1 through L-7 with their D-*/LED-Ghost-Fix pairings, prototype revisions P-2/P-3, the newest known H-4/I-4 revision, the German-distributor-only L-6/D-6, a home/competition L-5C patch, and the 2026 community ball-saver patches `taf_d7bs` and `taf_i4bs`. Every one of these is a firmware revision for the same physical machine.
