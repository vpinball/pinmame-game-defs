...
- The pinned PinMAME source declares `eightbll` at `src/wpc/by35games.c:139` with machine module `by35_mBY17`; no platform is declared (no reviewed profile covers that module yet).
