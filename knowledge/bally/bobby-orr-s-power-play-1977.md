...
- The pinned PinMAME source declares `pwerplay` at `src/wpc/by35games.c:176` with machine module `by35_mBY17`; no platform is declared (no reviewed profile covers that module yet).
