# Olympus (Juegos Populares 1986)

Coverage: **partial - machine identity plus candidate-only I/O attachments. Playfield devices,
wiring, mechanisms, and behavior are evidenced only as unverified candidates.**

This record was promoted from the generated catalog stub `stub.pinmame.olympus` by the
...
- PinMAME catalog: root driver `olympus`, description "Olympus", manufacturer
...
- The definition's driver list is exactly the clone tree PinMAME declares under `olympus`;
  whether every listed driver really runs on this physical machine is unverified.

## Drivers this record holds

- `olympus` (1986, Juegos Populares).
