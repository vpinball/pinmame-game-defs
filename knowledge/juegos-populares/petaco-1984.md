# Petaco (Juegos Populares 1984)

Coverage: **partial - machine identity plus candidate-only I/O attachments. Playfield devices,
wiring, mechanisms, and behavior are evidenced only as unverified candidates.**

This record was promoted from the generated catalog stub `stub.pinmame.petaco` by the
...
- PinMAME catalog: root driver `petaco`, description "Petaco", manufacturer
  "Juegos Populares", catalog year "1984".
...
- The definition's driver list is exactly the clone tree PinMAME declares under `petaco`;
  whether every listed driver really runs on this physical machine is unverified.

## Drivers this record holds

- `petaco` (1984, Juegos Populares).
