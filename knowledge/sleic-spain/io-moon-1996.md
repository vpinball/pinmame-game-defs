# Io Moon (Sleic (Spain) 1996)

Coverage: **partial - machine identity only. Nothing about playfield devices, wiring, mechanisms,
or behavior is evidenced yet.**

This record was promoted from the generated catalog stub `stub.pinmame.iomoon` by the
...
- The definition's driver list is exactly the clone tree PinMAME declares under `iomoon`;
