...
This record was promoted from the generated catalog stub `stub.pinmame.howzat` by the
...
- PinMAME catalog: root driver `howzat`, description "Howzat", manufacturer
  "Hankin", catalog year "1980".
...
- The definition's driver list is exactly the clone tree PinMAME declares under `howzat`;
