...
- The pinned PinMAME source declares `bullseye` at `src/wpc/by35games.c:1952` with machine module `by35_GP`; no reviewed profile covers that module yet, so no platform is declared.
