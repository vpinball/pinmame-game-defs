...
This record was promoted from the generated catalog stub `stub.pinmame.antar` by the
...
- PinMAME catalog: root driver `antar`, description "Antar", manufacturer
  "Playmatic", catalog year "1979".
...
- The definition's driver list is exactly the clone tree PinMAME declares under `antar`;
  whether every listed driver really runs on this physical machine is unverified.

## Drivers this record holds

- `antar` (1979, Playmatic).
- `antar2` (1979, Playmatic, clone of `antar`).
