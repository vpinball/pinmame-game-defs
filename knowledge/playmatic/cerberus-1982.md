# Cerberus (Playmatic 1982)

Coverage: **partial - machine identity only. Nothing about playfield devices, wiring, mechanisms,
or behavior is evidenced yet.**

This record was promoted from the generated catalog stub `stub.pinmame.cerberus` by the
...
- PinMAME catalog: root driver `cerberus`, description "Cerberus", manufacturer
  "Playmatic", catalog year "1982".
...
- The definition's driver list is exactly the clone tree PinMAME declares under `cerberus`;
  whether every listed driver really runs on this physical machine is unverified.

## Drivers this record holds

- `cerberus` (1982, Playmatic).
