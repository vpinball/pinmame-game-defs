...
This record was promoted from the generated catalog stub `stub.pinmame.zira` by the
...
- PinMAME catalog: root driver `zira`, description "Zira", manufacturer
  "Playmatic", catalog year "1981".
...
- The definition's driver list is exactly the clone tree PinMAME declares under `zira`;
