...
This record was promoted from the generated catalog stub `stub.pinmame.blkfever` by the
...
- PinMAME catalog: root driver `blkfever`, description "Black Fever", manufacturer
  "Playmatic", catalog year "1980".
...
- The definition's driver list is exactly the clone tree PinMAME declares under `blkfever`;
  whether every listed driver really runs on this physical machine is unverified.

## Drivers this record holds

- `blkfever` (1980, Playmatic).
