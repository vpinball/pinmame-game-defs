...
- Candidate root driver: `movmastr`
- Candidate manufacturer: Jac Van Ham (Royal)
- Candidate year: 19??
- Drivers currently grouped by the PinMAME clone chain: `movmastr`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `movmastr`.
