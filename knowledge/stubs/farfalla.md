...
- Candidate root driver: `farfalla`
- Candidate manufacturer: Zaccaria
- Candidate year: 1983
- Drivers currently grouped by the PinMAME clone chain: `farfalla`, `farfallaa`, `farfallf`, `farfallfa`, `farfallg`, `farfallga`, `farfalli`, `farfallia`, `farfffp`, `farffp`, `farfgfp`, `farfifp`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `farfalla`.
