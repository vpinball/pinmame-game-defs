...
- Candidate root driver: `newdixie`
- Candidate manufacturer: Sirmo (Belgium)
- Candidate year: 19??
- Drivers currently grouped by the PinMAME clone chain: `newdixie`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `newdixie`.
