...
- Candidate root driver: `redbaron`
- Candidate manufacturer: Barni
- Candidate year: 1985
- Drivers currently grouped by the PinMAME clone chain: `redbaron`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `redbaron`.
