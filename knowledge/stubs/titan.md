...
- Candidate root driver: `titan`
- Candidate manufacturer: Taito
- Candidate year: 1982
- Drivers currently grouped by the PinMAME clone chain: `titan`, `titan1`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `titan`.
