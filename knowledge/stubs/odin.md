...
- Candidate root driver: `odin`
- Candidate manufacturer: Peyper (Spain)
- Candidate year: 1985
- Drivers currently grouped by the PinMAME clone chain: `odin`, `odin_dlx`, `odinp`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `odin`.
