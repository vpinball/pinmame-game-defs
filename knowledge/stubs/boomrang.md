# STUB - Boomerang (Engineering Prototype, patched patent code)
...
- Candidate root driver: `boomrang`
- Candidate manufacturer: Bally
- Candidate year: 1975
- Drivers currently grouped by the PinMAME clone chain: `boomranb`, `boomrang`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `boomrang`.
