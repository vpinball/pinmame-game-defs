...
- Candidate root driver: `fantacar`
- Candidate manufacturer: IDSA (Spain)
- Candidate year: 1986
- Drivers currently grouped by the PinMAME clone chain: `fantacar`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `fantacar`.
