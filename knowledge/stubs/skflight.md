...
- Candidate root driver: `skflight`
- Candidate manufacturer: Nuova Bell Games
- Candidate year: 1986
- Drivers currently grouped by the PinMAME clone chain: `skflight`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `skflight`.
