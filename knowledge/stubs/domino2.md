...
- Candidate root driver: `domino2`
- Candidate manufacturer: Sirmo (Belgium)
- Candidate year: 19??
- Drivers currently grouped by the PinMAME clone chain: `domino2`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `domino2`.
