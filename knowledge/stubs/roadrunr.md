...
- Candidate root driver: `roadrunr`
- Candidate manufacturer: Atari
- Candidate year: 1979
- Drivers currently grouped by the PinMAME clone chain: `roadrunr`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `roadrunr`.
