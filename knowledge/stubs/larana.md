...
- Candidate root driver: `larana`
- Candidate manufacturer: Inder (Spain)
- Candidate year: 1990
- Drivers currently grouped by the PinMAME clone chain: `larana`, `larana2`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `larana`.
