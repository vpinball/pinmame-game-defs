...
- Candidate root driver: `jamesb`
- Candidate manufacturer: Gottlieb
- Candidate year: 1980
- Drivers currently grouped by the PinMAME clone chain: `jamesb`, `jamesb2`, `jamesb7`, `jamesb7b`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `jamesb`.
