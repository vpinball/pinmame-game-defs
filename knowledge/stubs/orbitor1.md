...
- Candidate root driver: `orbitor1`
- Candidate manufacturer: Stern
- Candidate year: 1982
- Drivers currently grouped by the PinMAME clone chain: `orbitofp`, `orbitor1`, `orbitora`, `orbitorb`, `orbitorc`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `orbitor1`.
