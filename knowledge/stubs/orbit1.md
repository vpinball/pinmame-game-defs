...
- Candidate root driver: `orbit1`
- Candidate manufacturer: Hankin
- Candidate year: 1978
- Drivers currently grouped by the PinMAME clone chain: `orbit1`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `orbit1`.
