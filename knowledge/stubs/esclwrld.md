# STUB - Escape from the Lost World
...
- Candidate root driver: `esclwrld`
- Candidate manufacturer: Bally
- Candidate year: 1987
- Drivers currently grouped by the PinMAME clone chain: `esclwrld`, `esclwrlg`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `esclwrld`.
