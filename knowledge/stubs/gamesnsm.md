...
- Candidate root driver: `gamesnsm`
- Candidate manufacturer: NSM (Germany)
- Candidate year: 1985
- Drivers currently grouped by the PinMAME clone chain: `gamesnsm`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `gamesnsm`.
