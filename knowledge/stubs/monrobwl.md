...
- Candidate root driver: `monrobwl`
- Candidate manufacturer: Monroe Bowling Co.
- Candidate year: 19??
- Drivers currently grouped by the PinMAME clone chain: `monrobwl`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `monrobwl`.
