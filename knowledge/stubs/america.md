...
- Candidate root driver: `america`
- Candidate manufacturer: Juegos Populares
- Candidate year: 1986
- Drivers currently grouped by the PinMAME clone chain: `america`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `america`.
