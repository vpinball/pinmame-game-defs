# STUB - New Star's Phoenix (Italian Speech)
...
- Candidate root driver: `nstrphnx`
- Candidate manufacturer: Zaccaria
- Candidate year: 1987
- Drivers currently grouped by the PinMAME clone chain: `nstrpffp`, `nstrphfp`, `nstrphnf`, `nstrphnx`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `nstrphnx`.
