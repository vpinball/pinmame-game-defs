...
- Candidate root driver: `cobra`
- Candidate manufacturer: Nuova Bell Games
- Candidate year: 1987
- Drivers currently grouped by the PinMAME clone chain: `cobra`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `cobra`.
