...
- Candidate root driver: `nbamac`
- Candidate manufacturer: MAC S.A.
- Candidate year: 1996
- Drivers currently grouped by the PinMAME clone chain: `nbamac`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `nbamac`.
