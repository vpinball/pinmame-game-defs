...
- Candidate root driver: `dinoeggs`
- Candidate manufacturer: Alvin G
- Candidate year: 1993
- Drivers currently grouped by the PinMAME clone chain: `dinoeggs`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `dinoeggs`.
