...
- Candidate root driver: `ghv101`
- Candidate manufacturer: Romstar
- Candidate year: 1994
- Drivers currently grouped by the PinMAME clone chain: `ghv101`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `ghv101`.
