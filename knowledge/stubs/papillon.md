...
- Candidate root driver: `papillon`
- Candidate manufacturer: Video Dens
- Candidate year: 1986
- Drivers currently grouped by the PinMAME clone chain: `papillon`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `papillon`.
