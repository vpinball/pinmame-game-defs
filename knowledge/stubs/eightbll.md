...
- Candidate root driver: `eightbll`
- Candidate manufacturer: Bally
- Candidate year: 1977
- Drivers currently grouped by the PinMAME clone chain: `eightblb`, `eightblc`, `eightbll`, `eightblo`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `eightbll`.
