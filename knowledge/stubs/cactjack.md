...
- Candidate root driver: `cactjack`
- Candidate manufacturer: Gottlieb
- Candidate year: 1991
- Drivers currently grouped by the PinMAME clone chain: `cactjack`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `cactjack`.
