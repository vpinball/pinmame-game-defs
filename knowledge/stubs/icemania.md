...
- Candidate root driver: `icemania`
- Candidate manufacturer: Jac Van Ham (Royal)
- Candidate year: 1986
- Drivers currently grouped by the PinMAME clone chain: `icemania`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `icemania`.
