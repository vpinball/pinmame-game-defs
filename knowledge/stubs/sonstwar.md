...
- Candidate root driver: `sonstwar`
- Candidate manufacturer: Sonic (Spain)
- Candidate year: 1987
- Drivers currently grouped by the PinMAME clone chain: `sonstwar`, `sonstwr2`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `sonstwar`.
