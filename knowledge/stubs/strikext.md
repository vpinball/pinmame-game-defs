...
- Candidate root driver: `strikext`
- Candidate manufacturer: Stern
- Candidate year: 2000
- Drivers currently grouped by the PinMAME clone chain: `strikext`, `strxt_fr`, `strxt_gr`, `strxt_it`, `strxt_it_100`, `strxt_it_101`, `strxt_sp`, `strxt_uk`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `strikext`.
