...
- Candidate root driver: `arena`
- Candidate manufacturer: Gottlieb
- Candidate year: 1987
- Drivers currently grouped by the PinMAME clone chain: `arena`, `arena2`, `arena_fp`, `arenaa`, `arenaafp`, `arenaf`, `arenaffp`, `arenag`, `arenagfp`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `arena`.
