...
- Candidate root driver: `stars`
- Candidate manufacturer: Stern
- Candidate year: 1978
- Drivers currently grouped by the PinMAME clone chain: `stars`, `starsb`, `starsb7`, `starsfp`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `stars`.
