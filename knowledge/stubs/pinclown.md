...
- Candidate root driver: `pinclown`
- Candidate manufacturer: Inder (Spain)
- Candidate year: 1988
- Drivers currently grouped by the PinMAME clone chain: `pinclofp`, `pinclown`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `pinclown`.
