...
- Candidate root driver: `mousn_l4`
- Candidate manufacturer: Bally
- Candidate year: 1989
- Drivers currently grouped by the PinMAME clone chain: `mousn_l1`, `mousn_l4`, `mousn_l4c`, `mousn_lu`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `mousn_l4`.
