...
- Candidate root driver: `uboat65`
- Candidate manufacturer: Nuova Bell Games
- Candidate year: 1988
- Drivers currently grouped by the PinMAME clone chain: `uboat65`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `uboat65`.
