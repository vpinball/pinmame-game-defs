...
- Candidate root driver: `stk_sprs`
- Candidate manufacturer: Bally
- Candidate year: 1978
- Drivers currently grouped by the PinMAME clone chain: `stk_sprb`, `stk_sprc`, `stk_sprs`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `stk_sprs`.
