...
- Candidate root driver: `simp_a27`
- Candidate manufacturer: Data East
- Candidate year: 1990
- Drivers currently grouped by the PinMAME clone chain: `simp_a20`, `simp_a27`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `simp_a27`.
