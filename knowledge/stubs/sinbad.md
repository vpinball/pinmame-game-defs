...
- Candidate root driver: `sinbad`
- Candidate manufacturer: Gottlieb
- Candidate year: 1978
- Drivers currently grouped by the PinMAME clone chain: `sinbad`, `sinbadn`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `sinbad`.
