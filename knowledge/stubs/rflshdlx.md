...
- Candidate root driver: `rflshdlx`
- Candidate manufacturer: Gottlieb
- Candidate year: 1983
- Drivers currently grouped by the PinMAME clone chain: `rflshdlx`, `rflshdlx1`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `rflshdlx`.
