...
- Candidate root driver: `bmx`
- Candidate manufacturer: Bally
- Candidate year: 1983
- Drivers currently grouped by the PinMAME clone chain: `bmx`, `bmxa`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `bmx`.
