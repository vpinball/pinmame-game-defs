...
- Candidate root driver: `rotation`
- Candidate manufacturer: Midway
- Candidate year: 1978
- Drivers currently grouped by the PinMAME clone chain: `rota_101`, `rota_115`, `rotation`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `rotation`.
