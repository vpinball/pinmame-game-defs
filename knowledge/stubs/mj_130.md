...
- Candidate root driver: `mj_130`
- Candidate manufacturer: Data East
- Candidate year: 1992
- Drivers currently grouped by the PinMAME clone chain: `mj_130`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `mj_130`.
