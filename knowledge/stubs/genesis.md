...
- Candidate root driver: `genesis`
- Candidate manufacturer: Gottlieb
- Candidate year: 1986
- Drivers currently grouped by the PinMAME clone chain: `genesffp`, `genesgfp`, `genesifp`, `genesis`, `genesisf`, `genesisg`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `genesis`.
