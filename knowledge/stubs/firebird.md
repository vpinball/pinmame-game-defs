...
- Candidate root driver: `firebird`
- Candidate manufacturer: NSM (Germany)
- Candidate year: 1985
- Drivers currently grouped by the PinMAME clone chain: `firebird`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `firebird`.
