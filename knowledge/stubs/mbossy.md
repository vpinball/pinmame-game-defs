...
- Candidate root driver: `mbossy`
- Candidate manufacturer: Game Plan
- Candidate year: 1982
- Drivers currently grouped by the PinMAME clone chain: `mbossy`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `mbossy`.
