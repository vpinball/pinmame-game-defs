...
- Candidate root driver: `wldcp_l1`
- Candidate manufacturer: Williams
- Candidate year: 1978
- Drivers currently grouped by the PinMAME clone chain: `wldcp_l1`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `wldcp_l1`.
