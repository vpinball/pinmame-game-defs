...
- Candidate root driver: `genie`
- Candidate manufacturer: Gottlieb
- Candidate year: 1979
- Drivers currently grouped by the PinMAME clone chain: `genie`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `genie`.
