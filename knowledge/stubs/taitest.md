...
- Candidate root driver: `taitest`
- Candidate manufacturer: Taito
- Candidate year: 198?
- Drivers currently grouped by the PinMAME clone chain: `taitest`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `taitest`.
