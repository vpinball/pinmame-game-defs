...
- Candidate root driver: `nudgeit`
- Candidate manufacturer: Gottlieb
- Candidate year: 1990
- Drivers currently grouped by the PinMAME clone chain: `nudgeit`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `nudgeit`.
