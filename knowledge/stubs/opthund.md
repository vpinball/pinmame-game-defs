...
- Candidate root driver: `opthund`
- Candidate manufacturer: Gottlieb
- Candidate year: 1992
- Drivers currently grouped by the PinMAME clone chain: `opthund`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `opthund`.
