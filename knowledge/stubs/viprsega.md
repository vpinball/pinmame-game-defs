...
- Candidate root driver: `viprsega`
- Candidate manufacturer: Sega
- Candidate year: 1998
- Drivers currently grouped by the PinMAME clone chain: `vipr_102`, `viprsega`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `viprsega`.
