...
- Candidate root driver: `sprbreak`
- Candidate manufacturer: Gottlieb
- Candidate year: 1987
- Drivers currently grouped by the PinMAME clone chain: `sprbrafp`, `sprbreak`, `sprbrffp`, `sprbrgfp`, `sprbrka`, `sprbrkf`, `sprbrkfp`, `sprbrkg`, `sprbrks`, `sprbrsfp`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `sprbreak`.
