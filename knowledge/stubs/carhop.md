...
- Candidate root driver: `carhop`
- Candidate manufacturer: Gottlieb
- Candidate year: 1991
- Drivers currently grouped by the PinMAME clone chain: `carhop`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `carhop`.
