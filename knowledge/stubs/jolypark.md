...
- Candidate root driver: `jolypark`
- Candidate manufacturer: Spinball (Spain)
- Candidate year: 1996
- Drivers currently grouped by the PinMAME clone chain: `jolypark`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `jolypark`.
