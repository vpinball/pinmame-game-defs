...
- Candidate root driver: `cueball`
- Candidate manufacturer: Gottlieb
- Candidate year: 1992
- Drivers currently grouped by the PinMAME clone chain: `cueball`, `cueball1`, `cueball2`, `cueball3`, `cueballv`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `cueball`.
