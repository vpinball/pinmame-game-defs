...
- Candidate root driver: `mrblack`
- Candidate manufacturer: Taito
- Candidate year: 1984
- Drivers currently grouped by the PinMAME clone chain: `mrblack`, `mrblack1`, `mrblkz80`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `mrblack`.
