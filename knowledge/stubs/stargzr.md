...
- Candidate root driver: `stargzr`
- Candidate manufacturer: Stern
- Candidate year: 1980
- Drivers currently grouped by the PinMAME clone chain: `stargzfp`, `stargzr`, `stargzrb`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `stargzr`.
