...
- Candidate root driver: `sys1test`
- Candidate manufacturer: Gottlieb
- Candidate year: 19??
- Drivers currently grouped by the PinMAME clone chain: `sys1test`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `sys1test`.
