...
- Candidate root driver: `flashman`
- Candidate manufacturer: Sport Matic
- Candidate year: 1984
- Drivers currently grouped by the PinMAME clone chain: `flashman`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `flashman`.
