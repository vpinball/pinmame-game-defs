...
- Candidate root driver: `seawitch`
- Candidate manufacturer: Stern
- Candidate year: 1980
- Drivers currently grouped by the PinMAME clone chain: `seawitch`, `seawitcha`, `seawitchb`, `seawitchc`, `seawitchd`, `seawitche`, `seawitchf`, `seawitfp`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `seawitch`.
