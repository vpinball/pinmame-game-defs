...
- Candidate root driver: `dvlrider`
- Candidate manufacturer: Zaccaria
- Candidate year: 1984
- Drivers currently grouped by the PinMAME clone chain: `dvlrdffp`, `dvlrdfp`, `dvlrdgfp`, `dvlrdifp`, `dvlridef`, `dvlrideg`, `dvlridei`, `dvlrider`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `dvlrider`.
