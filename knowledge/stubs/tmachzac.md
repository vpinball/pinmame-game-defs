...
- Candidate root driver: `tmachzac`
- Candidate manufacturer: Zaccaria
- Candidate year: 1983
- Drivers currently grouped by the PinMAME clone chain: `tmacffp`, `tmacfzac`, `tmacgfp`, `tmacgzac`, `tmachfp`, `tmachzac`, `tmachzaca`, `tmacifp`, `tmacizac`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `tmachzac`.
