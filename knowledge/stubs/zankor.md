# STUB - Zankor (TMS5200 Italian Speech)
...
- Candidate root driver: `zankor`
- Candidate manufacturer: Zaccaria
- Candidate year: 1986
- Drivers currently grouped by the PinMAME clone chain: `zank2ifp`, `zankor`, `zankor2i`, `zankore`, `zankorefp`, `zankorfp`, `zankorg`, `zankorgfp`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `zankor`.
