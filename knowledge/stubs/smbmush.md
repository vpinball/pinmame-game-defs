# STUB - Super Mario Bros. Mushroom World
...
- Candidate root driver: `smbmush`
- Candidate manufacturer: Gottlieb
- Candidate year: 1992
- Drivers currently grouped by the PinMAME clone chain: `smbmush`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `smbmush`.
