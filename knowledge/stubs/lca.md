...
- Candidate root driver: `lca`
- Candidate manufacturer: Gottlieb
- Candidate year: 1989
- Drivers currently grouped by the PinMAME clone chain: `lca`, `lca2`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `lca`.
