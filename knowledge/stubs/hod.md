...
- Candidate root driver: `hod`
- Candidate manufacturer: Zaccaria
- Candidate year: 1978
- Drivers currently grouped by the PinMAME clone chain: `hod`, `hodf`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `hod`.
