...
- Candidate root driver: `goldwing`
- Candidate manufacturer: Gottlieb
- Candidate year: 1986
- Drivers currently grouped by the PinMAME clone chain: `gldwgffp`, `gldwggfp`, `gldwingf`, `gldwingg`, `goldwgfp`, `goldwing`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `goldwing`.
