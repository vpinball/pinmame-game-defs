...
- Candidate root driver: `gladiatr`
- Candidate manufacturer: Gottlieb
- Candidate year: 1993
- Drivers currently grouped by the PinMAME clone chain: `gladiatr`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `gladiatr`.
