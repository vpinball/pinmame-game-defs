...
- Candidate root driver: `motrshow`
- Candidate manufacturer: Mr. Game (Italy)
- Candidate year: 1988
- Drivers currently grouped by the PinMAME clone chain: `motrshow`, `motrshwa`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `motrshow`.
