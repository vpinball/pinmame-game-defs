...
- Candidate root driver: `party`
- Candidate manufacturer: Playmatic
- Candidate year: 1979
- Drivers currently grouped by the PinMAME clone chain: `party`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `party`.
