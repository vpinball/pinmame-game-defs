...
- Candidate root driver: `omni_l1`
- Candidate manufacturer: Williams
- Candidate year: 1980
- Drivers currently grouped by the PinMAME clone chain: `omni_l1`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `omni_l1`.
