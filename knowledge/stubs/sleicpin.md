...
- Candidate root driver: `sleicpin`
- Candidate manufacturer: Sleic (Spain)
- Candidate year: 1993
- Drivers currently grouped by the PinMAME clone chain: `sleicpin`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `sleicpin`.
