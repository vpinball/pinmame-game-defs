# STUB - Al's Garage Band Goes On a World Tour (R01c Version B)
...
- Candidate root driver: `wrldtour`
- Candidate manufacturer: Alvin G
- Candidate year: 1993
- Drivers currently grouped by the PinMAME clone chain: `wrldtou2`, `wrldtou3`, `wrldtou4`, `wrldtour`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `wrldtour`.
