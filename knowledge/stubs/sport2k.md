...
- Candidate root driver: `sport2k`
- Candidate manufacturer: Cirsa
- Candidate year: 1988
- Drivers currently grouped by the PinMAME clone chain: `sport2k`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `sport2k`.
