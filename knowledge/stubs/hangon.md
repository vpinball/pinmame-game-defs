...
- Candidate root driver: `hangon`
- Candidate manufacturer: Sonic (Spain)
- Candidate year: 1988
- Drivers currently grouped by the PinMAME clone chain: `hangon`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `hangon`.
