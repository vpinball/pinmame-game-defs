...
- Candidate root driver: `shr_141`
- Candidate manufacturer: Stern
- Candidate year: 2008
- Drivers currently grouped by the PinMAME clone chain: `shr_130`, `shr_141`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `shr_141`.
