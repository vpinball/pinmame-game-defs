...
- Candidate root driver: `cntforce`
- Candidate manufacturer: Gottlieb
- Candidate year: 1980
- Drivers currently grouped by the PinMAME clone chain: `cntforc7`, `cntforce`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `cntforce`.
