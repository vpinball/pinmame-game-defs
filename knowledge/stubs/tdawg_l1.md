...
- Candidate root driver: `tdawg_l1`
- Candidate manufacturer: Williams
- Candidate year: 1987
- Drivers currently grouped by the PinMAME clone chain: `tdawg_l1`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `tdawg_l1`.
