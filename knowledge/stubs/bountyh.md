...
- Candidate root driver: `bountyh`
- Candidate manufacturer: Gottlieb
- Candidate year: 1985
- Drivers currently grouped by the PinMAME clone chain: `bountgfp`, `bounthfp`, `bountyh`, `bountyhg`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `bountyh`.
