...
- Candidate root driver: `tfight`
- Candidate manufacturer: Gottlieb
- Candidate year: 1990
- Drivers currently grouped by the PinMAME clone chain: `tfight`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `tfight`.
