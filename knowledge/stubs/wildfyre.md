...
- Candidate root driver: `wildfyre`
- Candidate manufacturer: Stern
- Candidate year: 1978
- Drivers currently grouped by the PinMAME clone chain: `wildfyfp`, `wildfyrc`, `wildfyre`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `wildfyre`.
