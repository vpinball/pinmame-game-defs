...
- Candidate root driver: `pomp_l1`
- Candidate manufacturer: Williams
- Candidate year: 1978
- Drivers currently grouped by the PinMAME clone chain: `pomp_l1`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `pomp_l1`.
