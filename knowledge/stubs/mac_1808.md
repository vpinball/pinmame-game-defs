...
- Candidate root driver: `mac_1808`
- Candidate manufacturer: MAC S.A.
- Candidate year: 19??
- Drivers currently grouped by the PinMAME clone chain: `mac_1808`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `mac_1808`.
