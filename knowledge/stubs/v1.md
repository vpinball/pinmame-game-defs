...
- Candidate root driver: `v1`
- Candidate manufacturer: IDSA (Spain)
- Candidate year: 1985
- Drivers currently grouped by the PinMAME clone chain: `v1`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `v1`.
