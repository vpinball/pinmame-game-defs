...
- Candidate root driver: `aftor`
- Candidate manufacturer: Wico
- Candidate year: 1984
- Drivers currently grouped by the PinMAME clone chain: `aftor`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `aftor`.
