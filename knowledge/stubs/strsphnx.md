# STUB - Star's Phoenix (Italian Speech)
...
- Candidate root driver: `strsphnx`
- Candidate manufacturer: Zaccaria
- Candidate year: 1987
- Drivers currently grouped by the PinMAME clone chain: `strspffp`, `strsphfp`, `strsphnf`, `strsphnx`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `strsphnx`.
