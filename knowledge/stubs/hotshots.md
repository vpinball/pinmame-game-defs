...
- Candidate root driver: `hotshots`
- Candidate manufacturer: Gottlieb
- Candidate year: 1989
- Drivers currently grouped by the PinMAME clone chain: `hotshffp`, `hotshgfp`, `hotshotf`, `hotshotg`, `hotshots`, `hotshtfp`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `hotshots`.
