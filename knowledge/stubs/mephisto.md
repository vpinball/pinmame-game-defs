...
- Candidate root driver: `mephisto`
- Candidate manufacturer: Stargame
- Candidate year: 1986
- Drivers currently grouped by the PinMAME clone chain: `mephist1`, `mephisto`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `mephisto`.
