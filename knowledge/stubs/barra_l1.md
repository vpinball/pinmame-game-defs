...
- Candidate root driver: `barra_l1`
- Candidate manufacturer: Williams
- Candidate year: 1981
- Drivers currently grouped by the PinMAME clone chain: `barra_l1`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `barra_l1`.
