...
- Candidate root driver: `suprpick`
- Candidate manufacturer: Allied Leisure
- Candidate year: 1977
- Drivers currently grouped by the PinMAME clone chain: `suprpick`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `suprpick`.
