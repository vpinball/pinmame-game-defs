...
- Candidate root driver: `cavnegro`
- Candidate manufacturer: Taito
- Candidate year: 1981
- Drivers currently grouped by the PinMAME clone chain: `cavnegr1`, `cavnegr2`, `cavnegro`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `cavnegro`.
