...
- Candidate root driver: `spidermn`
- Candidate manufacturer: Gottlieb
- Candidate year: 1980
- Drivers currently grouped by the PinMAME clone chain: `spiderm7`, `spidermn`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `spidermn`.
