...
- Candidate root driver: `olympic`
- Candidate manufacturer: Jeutel
- Candidate year: 1984
- Drivers currently grouped by the PinMAME clone chain: `olympic`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `olympic`.
