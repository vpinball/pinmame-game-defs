...
- Candidate root driver: `xfiles`
- Candidate manufacturer: Sega
- Candidate year: 1997
- Drivers currently grouped by the PinMAME clone chain: `xfiles`, `xfiles2`, `xfiles20`, `xfiles304`, `xfilesf`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `xfiles`.
