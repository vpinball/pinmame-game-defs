...
- Candidate root driver: `gunshot`
- Candidate manufacturer: Spinball (Spain)
- Candidate year: 1996
- Drivers currently grouped by the PinMAME clone chain: `gunshot`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `gunshot`.
