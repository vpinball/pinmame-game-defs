# STUB - Caveman (Pinball/Video Combo)
...
- Candidate root driver: `caveman`
- Candidate manufacturer: Gottlieb
- Candidate year: 1981
- Drivers currently grouped by the PinMAME clone chain: `caveman`, `cavemana`, `cavemane`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `caveman`.
