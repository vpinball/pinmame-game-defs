...
- Candidate root driver: `robot`
- Candidate manufacturer: Zaccaria
- Candidate year: 1985
- Drivers currently grouped by the PinMAME clone chain: `robot`, `robotf`, `robotffp`, `robotfp`, `robotg`, `robotgfp`, `roboti`, `robotifp`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `robot`.
