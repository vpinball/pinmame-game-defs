...
- Candidate root driver: `pentacp2`
- Candidate manufacturer: Micropin
- Candidate year: 1981
- Drivers currently grouped by the PinMAME clone chain: `pentacp2`, `pentacps`, `pentacpt`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `pentacp2`.
