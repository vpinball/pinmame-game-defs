...
- Candidate root driver: `hirolcas`
- Candidate manufacturer: Stern
- Candidate year: 2001
- Drivers currently grouped by the PinMAME clone chain: `hirol210`, `hirol_fr`, `hirol_g3`, `hirol_gr`, `hirol_it`, `hirolcas`, `hirolcat`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `hirolcas`.
