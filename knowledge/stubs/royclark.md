# STUB - Roy Clark - The Entertainer
...
- Candidate root driver: `royclark`
- Candidate manufacturer: Fascination Int.
- Candidate year: 1977
- Drivers currently grouped by the PinMAME clone chain: `royclark`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `royclark`.
