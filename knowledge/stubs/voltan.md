# STUB - Voltan Escapes Cosmic Doom
...
- Candidate root driver: `voltan`
- Candidate manufacturer: Bally
- Candidate year: 1978
- Drivers currently grouped by the PinMAME clone chain: `voltan`, `voltanb`, `voltanc`, `voltand`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `voltan`.
