...
- Candidate root driver: `spacejam`
- Candidate manufacturer: Sega
- Candidate year: 1997
- Drivers currently grouped by the PinMAME clone chain: `spacejam`, `spacejm2`, `spacejmf`, `spacejmg`, `spacejmi`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `spacejam`.
