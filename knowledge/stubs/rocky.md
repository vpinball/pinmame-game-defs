...
- Candidate root driver: `rocky`
- Candidate manufacturer: Gottlieb
- Candidate year: 1982
- Drivers currently grouped by the PinMAME clone chain: `rocky`, `rockyf`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `rocky`.
