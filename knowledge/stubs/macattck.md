...
- Candidate root driver: `macattck`
- Candidate manufacturer: Mr. Game (Italy)
- Candidate year: 1990
- Drivers currently grouped by the PinMAME clone chain: `macattck`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `macattck`.
