...
- Candidate root driver: `kz26`
- Candidate manufacturer: Playmatic
- Candidate year: 1985
- Drivers currently grouped by the PinMAME clone chain: `kz26`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `kz26`.
