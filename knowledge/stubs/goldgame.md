...
- Candidate root driver: `goldgame`
- Candidate manufacturer: Splin (Belgium)
- Candidate year: 19??
- Drivers currently grouped by the PinMAME clone chain: `goldgam2`, `goldgame`, `goldgkit1`, `goldgnew`, `goldgstake`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `goldgame`.
