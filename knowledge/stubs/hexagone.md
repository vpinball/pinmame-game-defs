...
- Candidate root driver: `hexagone`
- Candidate manufacturer: Christian Tabart (France)
- Candidate year: 1986
- Drivers currently grouped by the PinMAME clone chain: `hexagone`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `hexagone`.
