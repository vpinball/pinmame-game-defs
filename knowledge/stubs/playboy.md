...
- Candidate root driver: `playboy`
- Candidate manufacturer: Bally
- Candidate year: 1978
- Drivers currently grouped by the PinMAME clone chain: `playboy`, `playboyb`, `playboyc`, `playboyd`, `sexygirl`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `playboy`.
