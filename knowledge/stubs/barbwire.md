...
- Candidate root driver: `barbwire`
- Candidate manufacturer: Gottlieb
- Candidate year: 1996
- Drivers currently grouped by the PinMAME clone chain: `barbwire`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `barbwire`.
