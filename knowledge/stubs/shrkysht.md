...
- Candidate root driver: `shrkysht`
- Candidate manufacturer: Stern
- Candidate year: 2000
- Drivers currently grouped by the PinMAME clone chain: `shrky207`, `shrky_fr`, `shrky_gr`, `shrky_it`, `shrkysht`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `shrkysht`.
