...
- Candidate root driver: `striker`
- Candidate manufacturer: Gottlieb
- Candidate year: 1982
- Drivers currently grouped by the PinMAME clone chain: `striker`, `strikerf`, `strikerg`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `striker`.
