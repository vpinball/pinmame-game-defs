...
- Candidate root driver: `topgame`
- Candidate manufacturer: Splin (Belgium)
- Candidate year: 19??
- Drivers currently grouped by the PinMAME clone chain: `topgame`, `topgamet`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `topgame`.
