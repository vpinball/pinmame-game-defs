...
- Candidate root driver: `topazi`
- Candidate manufacturer: Inder (Spain)
- Candidate year: 1979
- Drivers currently grouped by the PinMAME clone chain: `topazi`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `topazi`.
