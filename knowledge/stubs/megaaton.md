...
- Candidate root driver: `megaaton`
- Candidate manufacturer: Playmatic
- Candidate year: 1984
- Drivers currently grouped by the PinMAME clone chain: `megaatoa`, `megaaton`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `megaaton`.
