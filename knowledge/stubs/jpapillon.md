...
- Candidate root driver: `jpapillon`
- Candidate manufacturer: Jeutel
- Candidate year: 1984
- Drivers currently grouped by the PinMAME clone chain: `jpapillon`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `jpapillon`.
