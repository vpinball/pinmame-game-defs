...
- Candidate root driver: `bullseye`
- Candidate manufacturer: Grand Products Inc.
- Candidate year: 1986
- Drivers currently grouped by the PinMAME clone chain: `bullsen2`, `bullsey2`, `bullseye`, `bullseyn`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `bullseye`.
