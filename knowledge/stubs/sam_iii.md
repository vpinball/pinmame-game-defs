# STUB - S.A.M. III Board Tester (on-board)
...
- Candidate root driver: `sam_iii`
- Candidate manufacturer: Stern
- Candidate year: 19??
- Drivers currently grouped by the PinMAME clone chain: `sam_iii`, `sam_iv`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `sam_iii`.
