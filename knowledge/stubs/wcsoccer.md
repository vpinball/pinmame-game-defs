# STUB - World Challenge Soccer (rev. 1)
...
- Candidate root driver: `wcsoccer`
- Candidate manufacturer: Gottlieb
- Candidate year: 1994
- Drivers currently grouped by the PinMAME clone chain: `wcsoccd2`, `wcsoccer`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `wcsoccer`.
