...
- Candidate root driver: `atarians`
- Candidate manufacturer: Atari
- Candidate year: 1976
- Drivers currently grouped by the PinMAME clone chain: `atarianf`, `atarians`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `atarians`.
