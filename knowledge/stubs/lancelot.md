...
- Candidate root driver: `lancelot`
- Candidate manufacturer: Peyper (Spain)
- Candidate year: 1994
- Drivers currently grouped by the PinMAME clone chain: `lancelot`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `lancelot`.
