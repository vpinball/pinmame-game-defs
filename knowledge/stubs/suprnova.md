...
- Candidate root driver: `suprnova`
- Candidate manufacturer: Game Plan
- Candidate year: 1982
- Drivers currently grouped by the PinMAME clone chain: `suprnova`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `suprnova`.
