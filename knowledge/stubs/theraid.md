...
- Candidate root driver: `theraid`
- Candidate manufacturer: Playmatic
- Candidate year: 1984
- Drivers currently grouped by the PinMAME clone chain: `theraid`, `theraida`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `theraid`.
