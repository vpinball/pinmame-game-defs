...
- Candidate root driver: `jack2opn`
- Candidate manufacturer: Gottlieb
- Candidate year: 1984
- Drivers currently grouped by the PinMAME clone chain: `jack2opn`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `jack2opn`.
