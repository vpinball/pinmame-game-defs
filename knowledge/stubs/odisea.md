...
- Candidate root driver: `odisea`
- Candidate manufacturer: Peyper (Spain)
- Candidate year: 1987
- Drivers currently grouped by the PinMAME clone chain: `odisea`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `odisea`.
