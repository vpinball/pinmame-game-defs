# STUB - WPC Test Fixture: Security (1.2)
...
- Candidate root driver: `tfs_12`
- Candidate manufacturer: Bally
- Candidate year: 1994
- Drivers currently grouped by the PinMAME clone chain: `tfs_12`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `tfs_12`.
