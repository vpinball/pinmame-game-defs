...
- Candidate root driver: `tt_game`
- Candidate manufacturer: Gottlieb
- Candidate year: 19??
- Drivers currently grouped by the PinMAME clone chain: `tt_game`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `tt_game`.
