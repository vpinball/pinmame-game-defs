...
- Candidate root driver: `grand8`
- Candidate manufacturer: Christian Tabart (France)
- Candidate year: 1985
- Drivers currently grouped by the PinMAME clone chain: `grand8`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `grand8`.
