...
- Candidate root driver: `solaride`
- Candidate manufacturer: Gottlieb
- Candidate year: 1979
- Drivers currently grouped by the PinMAME clone chain: `solaride`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `solaride`.
