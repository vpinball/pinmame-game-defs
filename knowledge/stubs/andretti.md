...
- Candidate root driver: `andretti`
- Candidate manufacturer: Gottlieb
- Candidate year: 1995
- Drivers currently grouped by the PinMAME clone chain: `andrett4`, `andretti`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `andretti`.
