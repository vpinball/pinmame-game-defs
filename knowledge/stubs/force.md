...
- Candidate root driver: `force`
- Candidate manufacturer: LTD
- Candidate year: 198?
- Drivers currently grouped by the PinMAME clone chain: `force`, `force_ekky`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `force`.
