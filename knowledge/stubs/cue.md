...
- Candidate root driver: `cue`
- Candidate manufacturer: Stern
- Candidate year: 1982
- Drivers currently grouped by the PinMAME clone chain: `cue`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `cue`.
