...
- Candidate root driver: `cosmic`
- Candidate manufacturer: Taito
- Candidate year: 1981
- Drivers currently grouped by the PinMAME clone chain: `cosmic`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `cosmic`.
