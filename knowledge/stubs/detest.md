...
- Candidate root driver: `detest`
- Candidate manufacturer: Data East
- Candidate year: 1998
- Drivers currently grouped by the PinMAME clone chain: `detest`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `detest`.
