...
- Candidate root driver: `embryon`
- Candidate manufacturer: Bally
- Candidate year: 1981
- Drivers currently grouped by the PinMAME clone chain: `embryon`, `embryona`, `embryonb`, `embryonc`, `embryond`, `embryone`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `embryon`.
