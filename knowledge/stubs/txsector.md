...
- Candidate root driver: `txsector`
- Candidate manufacturer: Gottlieb
- Candidate year: 1988
- Drivers currently grouped by the PinMAME clone chain: `txsecffp`, `txsecgfp`, `txsectfp`, `txsector`, `txsectrf`, `txsectrg`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `txsector`.
