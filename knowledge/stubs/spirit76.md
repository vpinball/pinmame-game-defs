...
- Candidate root driver: `spirit76`
- Candidate manufacturer: Mirco
- Candidate year: 1975
- Drivers currently grouped by the PinMAME clone chain: `spirit76`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `spirit76`.
