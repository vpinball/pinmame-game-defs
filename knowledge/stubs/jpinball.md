...
- Candidate root driver: `jpinball`
- Candidate manufacturer: Joctronic
- Candidate year: 198?
- Drivers currently grouped by the PinMAME clone chain: `jpinball`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `jpinball`.
