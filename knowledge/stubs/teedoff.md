...
- Candidate root driver: `teedoff`
- Candidate manufacturer: Gottlieb
- Candidate year: 1993
- Drivers currently grouped by the PinMAME clone chain: `teedoff`, `teedoff1`, `teedoff3`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `teedoff`.
