...
- Candidate root driver: `phntmshp`
- Candidate manufacturer: Playmatic
- Candidate year: 1987
- Drivers currently grouped by the PinMAME clone chain: `phntmshp`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `phntmshp`.
