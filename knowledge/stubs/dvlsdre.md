...
- Candidate root driver: `dvlsdre`
- Candidate manufacturer: Gottlieb
- Candidate year: 1982
- Drivers currently grouped by the PinMAME clone chain: `dvlsdre`, `dvlsdre2`, `dvlsdrea`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `dvlsdre`.
