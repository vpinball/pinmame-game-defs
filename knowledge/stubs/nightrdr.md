...
- Candidate root driver: `nightrdr`
- Candidate manufacturer: Bally
- Candidate year: 1977
- Drivers currently grouped by the PinMAME clone chain: `nightr20`, `nightrdb`, `nightrdc`, `nightrdr`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `nightrdr`.
