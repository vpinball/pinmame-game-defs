...
- Candidate root driver: `macjungl`
- Candidate manufacturer: MAC S.A.
- Candidate year: 1986
- Drivers currently grouped by the PinMAME clone chain: `macjungl`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `macjungl`.
