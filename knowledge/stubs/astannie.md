# STUB - Asteroid Annie and the Aliens
...
- Candidate root driver: `astannie`
- Candidate manufacturer: Gottlieb
- Candidate year: 1980
- Drivers currently grouped by the PinMAME clone chain: `astannie`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `astannie`.
