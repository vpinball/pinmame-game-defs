...
- Candidate root driver: `aavenger`
- Candidate manufacturer: Atari
- Candidate year: 1977
- Drivers currently grouped by the PinMAME clone chain: `aavengef`, `aavenger`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `aavenger`.
