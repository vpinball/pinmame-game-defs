...
- Candidate root driver: `spcpoker`
- Candidate manufacturer: LTD
- Candidate year: 198?
- Drivers currently grouped by the PinMAME clone chain: `spcpoker`, `spcpoker_ekky`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `spcpoker`.
