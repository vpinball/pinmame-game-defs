...
- Candidate root driver: `alienstr`
- Candidate manufacturer: Gottlieb
- Candidate year: 1984
- Drivers currently grouped by the PinMAME clone chain: `alienstr`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `alienstr`.
