...
- Candidate root driver: `mach2`
- Candidate manufacturer: Spinball (Spain)
- Candidate year: 1995
- Drivers currently grouped by the PinMAME clone chain: `mach2`, `mach2a`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `mach2`.
