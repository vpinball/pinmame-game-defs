...
- Candidate root driver: `cyclopes`
- Candidate manufacturer: Game Plan
- Candidate year: 1985
- Drivers currently grouped by the PinMAME clone chain: `cyclope1`, `cyclopes`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `cyclopes`.
