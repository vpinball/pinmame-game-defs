# STUB - WPC Test Fixture: Alphanumeric (L-3)
...
- Candidate root driver: `tfa_13`
- Candidate manufacturer: Bally
- Candidate year: 1990
- Drivers currently grouped by the PinMAME clone chain: `tfa_13`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `tfa_13`.
