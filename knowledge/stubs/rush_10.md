...
- Candidate root driver: `rush_10`
- Candidate manufacturer: Astill Entertainment
- Candidate year: 20??
- Drivers currently grouped by the PinMAME clone chain: `rush_10`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `rush_10`.
