...
- Candidate root driver: `spooky`
- Candidate manufacturer: Zaccaria
- Candidate year: 1987
- Drivers currently grouped by the PinMAME clone chain: `spookifp`, `spooky`, `spookyfp`, `spookyi`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `spooky`.
