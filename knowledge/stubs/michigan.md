...
- Candidate root driver: `michigan`
- Candidate manufacturer: Splin (Belgium)
- Candidate year: 19??
- Drivers currently grouped by the PinMAME clone chain: `michigan`, `michkit1`, `michkitb`, `michnew`, `michstake`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `michigan`.
