...
- Candidate root driver: `waterwld`
- Candidate manufacturer: Gottlieb
- Candidate year: 1995
- Drivers currently grouped by the PinMAME clone chain: `waterwl2`, `waterwl5`, `waterwld`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `waterwld`.
