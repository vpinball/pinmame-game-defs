...
- Candidate root driver: `wsports`
- Candidate manufacturer: Zaccaria
- Candidate year: 1978
- Drivers currently grouped by the PinMAME clone chain: `wsports`, `wsportsf`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `wsports`.
