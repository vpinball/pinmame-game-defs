...
- Candidate root driver: `fathom`
- Candidate manufacturer: Bally
- Candidate year: 1981
- Drivers currently grouped by the PinMAME clone chain: `fathom`, `fathoma`, `fathomb`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `fathom`.
