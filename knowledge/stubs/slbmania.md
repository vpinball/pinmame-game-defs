...
- Candidate root driver: `slbmania`
- Candidate manufacturer: Bally
- Candidate year: 1980
- Drivers currently grouped by the PinMAME clone chain: `slbmania`, `slbmanib`, `slbmanic`, `slbmanid`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `slbmania`.
