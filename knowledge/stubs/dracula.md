...
- Candidate root driver: `dracula`
- Candidate manufacturer: Stern
- Candidate year: 1979
- Drivers currently grouped by the PinMAME clone chain: `dracula`, `draculc`, `draculfp`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `dracula`.
