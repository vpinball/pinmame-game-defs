...
- Candidate root driver: `sshuttle`
- Candidate manufacturer: Taito
- Candidate year: 1985
- Drivers currently grouped by the PinMAME clone chain: `sshuttl1`, `sshuttle`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `sshuttle`.
