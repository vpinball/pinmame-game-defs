...
- Candidate root driver: `socrking`
- Candidate manufacturer: Zaccaria
- Candidate year: 1982
- Drivers currently grouped by the PinMAME clone chain: `sockfp`, `sockgfp`, `sockifp`, `socrkin2`, `socrkina`, `socrking`, `socrkngg`, `socrkngi`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `socrking`.
