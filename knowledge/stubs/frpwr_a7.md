# STUB - Firepower (Sys.7/6-digit conversion rev. 31)
...
- Candidate root driver: `frpwr_a7`
- Candidate manufacturer: Williams / Oliver
- Candidate year: 2005
- Drivers currently grouped by the PinMAME clone chain: `frpwr_a7`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `frpwr_a7`.
