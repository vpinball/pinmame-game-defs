...
- Candidate root driver: `sklflite`
- Candidate manufacturer: Playmatic
- Candidate year: 1987
- Drivers currently grouped by the PinMAME clone chain: `sklflite`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `sklflite`.
