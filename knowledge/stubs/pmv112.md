...
- Candidate root driver: `pmv112`
- Candidate manufacturer: Capcom
- Candidate year: 1995
- Drivers currently grouped by the PinMAME clone chain: `pmv112`, `pmv112r`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `pmv112`.
