...
- Candidate root driver: `storm`
- Candidate manufacturer: Sonic (Spain)
- Candidate year: 1979
- Drivers currently grouped by the PinMAME clone chain: `storm`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `storm`.
