...
- Candidate root driver: `sahalove`
- Candidate manufacturer: Christian Tabart (France)
- Candidate year: 1984
- Drivers currently grouped by the PinMAME clone chain: `sahalove`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `sahalove`.
