...
- Candidate root driver: `lastlap`
- Candidate manufacturer: Playmatic
- Candidate year: 1978
- Drivers currently grouped by the PinMAME clone chain: `lastlap`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `lastlap`.
