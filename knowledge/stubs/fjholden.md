...
- Candidate root driver: `fjholden`
- Candidate manufacturer: Hankin
- Candidate year: 1978
- Drivers currently grouped by the PinMAME clone chain: `fjholden`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `fjholden`.
