...
- Candidate root driver: `agent777`
- Candidate manufacturer: Game Plan
- Candidate year: 1984
- Drivers currently grouped by the PinMAME clone chain: `agent777`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `agent777`.
