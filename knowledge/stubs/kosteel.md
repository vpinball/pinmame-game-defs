...
- Candidate root driver: `kosteel`
- Candidate manufacturer: Bally
- Candidate year: 1984
- Drivers currently grouped by the PinMAME clone chain: `kosteel`, `kosteela`, `tigerrag`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `kosteel`.
