...
- Candidate root driver: `icecold`
- Candidate manufacturer: Taito
- Candidate year: 1983
- Drivers currently grouped by the PinMAME clone chain: `icecold`, `icecoldf`, `zekepeak`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `icecold`.
