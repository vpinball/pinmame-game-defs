...
- Candidate root driver: `thrdwrld`
- Candidate manufacturer: Sonic (Spain)
- Candidate year: 1978
- Drivers currently grouped by the PinMAME clone chain: `thrdwrld`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `thrdwrld`.
