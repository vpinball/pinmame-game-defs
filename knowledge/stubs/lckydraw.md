...
- Candidate root driver: `lckydraw`
- Candidate manufacturer: Mirco
- Candidate year: 1978
- Drivers currently grouped by the PinMAME clone chain: `lckydraa`, `lckydraw`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `lckydraw`.
