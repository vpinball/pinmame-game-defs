# STUB - Lost in Space (1.01, Display 1.02)
...
- Candidate root driver: `lostspc`
- Candidate manufacturer: Sega
- Candidate year: 1998
- Drivers currently grouped by the PinMAME clone chain: `lostspc`, `lostspc1`, `lostspcf`, `lostspcg`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `lostspc`.
