...
- Candidate root driver: `trident`
- Candidate manufacturer: Stern
- Candidate year: 1979
- Drivers currently grouped by the PinMAME clone chain: `tridenfp`, `trident`, `tridenta`, `tridentb`, `tridentc`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `trident`.
