...
- Candidate root driver: `wipeout`
- Candidate manufacturer: Gottlieb
- Candidate year: 1993
- Drivers currently grouped by the PinMAME clone chain: `wipeout`, `wipeouta`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `wipeout`.
