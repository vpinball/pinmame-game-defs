...
- Candidate root driver: `hvymetal`
- Candidate manufacturer: Bally
- Candidate year: 1987
- Drivers currently grouped by the PinMAME clone chain: `hvymetag`, `hvymetal`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `hvymetal`.
