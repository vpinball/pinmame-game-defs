...
- Candidate root driver: `formula1`
- Candidate manufacturer: Jac Van Ham (Royal)
- Candidate year: 1988
- Drivers currently grouped by the PinMAME clone chain: `formula1`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `formula1`.
