...
- Candidate root driver: `atla_ltd`
- Candidate manufacturer: LTD
- Candidate year: 19??
- Drivers currently grouped by the PinMAME clone chain: `atla_ltd`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `atla_ltd`.
