...
- Candidate root driver: `scrzy_l1`
- Candidate manufacturer: Williams
- Candidate year: 1984
- Drivers currently grouped by the PinMAME clone chain: `scrzy_l1`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `scrzy_l1`.
