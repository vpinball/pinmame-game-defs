...
- Candidate root driver: `tagteam`
- Candidate manufacturer: Gottlieb
- Candidate year: 1985
- Drivers currently grouped by the PinMAME clone chain: `tagteam`, `tagteam2`, `tagteamg`, `tagtem2f`, `tagtemfp`, `tagtmgfp`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `tagteam`.
