...
- Candidate root driver: `dalejr`
- Candidate manufacturer: Stern
- Candidate year: 2006
- Drivers currently grouped by the PinMAME clone chain: `dalejr`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `dalejr`.
