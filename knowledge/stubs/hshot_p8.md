# STUB - Hot Shot Basketball (P-8 Prototype)
...
- Candidate root driver: `hshot_p8`
- Candidate manufacturer: Midway
- Candidate year: 1992
- Drivers currently grouped by the PinMAME clone chain: `hshot_p8`, `hshot_p9`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `hshot_p8`.
