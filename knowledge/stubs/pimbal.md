...
- Candidate root driver: `pimbal`
- Candidate manufacturer: Juegos Populares
- Candidate year: 19??
- Drivers currently grouped by the PinMAME clone chain: `pimbal`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `pimbal`.
