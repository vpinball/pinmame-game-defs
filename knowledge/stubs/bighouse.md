...
- Candidate root driver: `bighouse`
- Candidate manufacturer: Gottlieb
- Candidate year: 1989
- Drivers currently grouped by the PinMAME clone chain: `bighosfp`, `bighouse`, `bighousf`, `bighousg`, `bighsffp`, `bighsgfp`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `bighouse`.
