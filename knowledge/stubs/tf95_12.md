# STUB - WPC Test Fixture: WPC-95 (1.2)
...
- Candidate root driver: `tf95_12`
- Candidate manufacturer: Bally
- Candidate year: 1996
- Drivers currently grouped by the PinMAME clone chain: `tf95_12`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `tf95_12`.
