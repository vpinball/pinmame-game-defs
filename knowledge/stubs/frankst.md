# STUB - Frankenstein, Mary Shelley's
...
- Candidate root driver: `frankst`
- Candidate manufacturer: Sega
- Candidate year: 1994
- Drivers currently grouped by the PinMAME clone chain: `frankst`, `frankstg`, `franksti`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `frankst`.
