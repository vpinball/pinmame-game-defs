...
- Candidate root driver: `terrlake`
- Candidate manufacturer: Sport Matic
- Candidate year: 1987
- Drivers currently grouped by the PinMAME clone chain: `terrlake`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `terrlake`.
