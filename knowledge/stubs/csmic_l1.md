...
- Candidate root driver: `csmic_l1`
- Candidate manufacturer: Williams
- Candidate year: 1980
- Drivers currently grouped by the PinMAME clone chain: `csmic_l1`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `csmic_l1`.
