...
- Candidate root driver: `deadweap`
- Candidate manufacturer: Gottlieb
- Candidate year: 1990
- Drivers currently grouped by the PinMAME clone chain: `deadweap`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `deadweap`.
