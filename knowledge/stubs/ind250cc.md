...
- Candidate root driver: `ind250cc`
- Candidate manufacturer: Inder (Spain)
- Candidate year: 1992
- Drivers currently grouped by the PinMAME clone chain: `ind250cc`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `ind250cc`.
