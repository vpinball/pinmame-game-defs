...
- Candidate root driver: `splitsec`
- Candidate manufacturer: Stern
- Candidate year: 1981
- Drivers currently grouped by the PinMAME clone chain: `splitsec`, `splitsfp`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `splitsec`.
