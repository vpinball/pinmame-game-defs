...
- Candidate root driver: `motrdome`
- Candidate manufacturer: Bally
- Candidate year: 1986
- Drivers currently grouped by the PinMAME clone chain: `motrdomb`, `motrdome`, `motrdomf`, `motrdomg`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `motrdome`.
