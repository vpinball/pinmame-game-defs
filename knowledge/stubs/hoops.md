...
- Candidate root driver: `hoops`
- Candidate manufacturer: Gottlieb
- Candidate year: 1991
- Drivers currently grouped by the PinMAME clone chain: `hoops`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `hoops`.
