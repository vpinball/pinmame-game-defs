...
- Candidate root driver: `cosflash`
- Candidate manufacturer: Bell Games
- Candidate year: 1985
- Drivers currently grouped by the PinMAME clone chain: `cosflash`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `cosflash`.
