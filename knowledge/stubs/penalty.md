...
- Candidate root driver: `penalty`
- Candidate manufacturer: Seeben (Belgium)
- Candidate year: 19??
- Drivers currently grouped by the PinMAME clone chain: `penalty`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `penalty`.
