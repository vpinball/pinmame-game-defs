# STUB - Wack-A-Doodle-Doo (Redemption)
...
- Candidate root driver: `wackadoo`
- Candidate manufacturer: Sega
- Candidate year: 1998
- Drivers currently grouped by the PinMAME clone chain: `wackadoo`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `wackadoo`.
