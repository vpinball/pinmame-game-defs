...
- Candidate root driver: `lectrono`
- Candidate manufacturer: Stern
- Candidate year: 1978
- Drivers currently grouped by the PinMAME clone chain: `lectrofp`, `lectrono`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `lectrono`.
