...
- Candidate root driver: `diamond`
- Candidate manufacturer: Gottlieb
- Candidate year: 1988
- Drivers currently grouped by the PinMAME clone chain: `diamnffp`, `diamngfp`, `diamond`, `diamondf`, `diamondg`, `diamonfp`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `diamond`.
