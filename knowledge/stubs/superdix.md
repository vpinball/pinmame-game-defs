...
- Candidate root driver: `superdix`
- Candidate manufacturer: Sirmo (Belgium)
- Candidate year: 19??
- Drivers currently grouped by the PinMAME clone chain: `superdix`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `superdix`.
