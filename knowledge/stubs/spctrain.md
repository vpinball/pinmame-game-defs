...
- Candidate root driver: `spctrain`
- Candidate manufacturer: MAC S.A.
- Candidate year: 1987
- Drivers currently grouped by the PinMAME clone chain: `spctrai0`, `spctrain`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `spctrain`.
