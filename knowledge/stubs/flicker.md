...
- Candidate root driver: `flicker`
- Candidate manufacturer: Nutting Associates
- Candidate year: 1974
- Drivers currently grouped by the PinMAME clone chain: `flicker`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `flicker`.
