...
- Candidate root driver: `snake`
- Candidate manufacturer: Taito
- Candidate year: 1982
- Drivers currently grouped by the PinMAME clone chain: `snake`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `snake`.
