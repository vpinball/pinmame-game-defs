...
- Candidate root driver: `badgirls`
- Candidate manufacturer: Gottlieb
- Candidate year: 1988
- Drivers currently grouped by the PinMAME clone chain: `badgirl2`, `badgirlf`, `badgirlg`, `badgirls`, `badgrffp`, `badgrgfp`, `badgrlfp`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `badgirls`.
