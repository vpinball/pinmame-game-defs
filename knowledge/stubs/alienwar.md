...
- Candidate root driver: `alienwar`
- Candidate manufacturer: LTD
- Candidate year: 198?
- Drivers currently grouped by the PinMAME clone chain: `alienwar`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `alienwar`.
