...
- Candidate root driver: `ngndshkr`
- Candidate manufacturer: Bally
- Candidate year: 1980
- Drivers currently grouped by the PinMAME clone chain: `ngndshkb`, `ngndshkm`, `ngndshkr`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `ngndshkr`.
