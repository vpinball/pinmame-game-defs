# STUB - Phantom Haus (0.4 Prototype)
...
- Candidate root driver: `ph_04`
- Candidate manufacturer: Williams
- Candidate year: 1996
- Drivers currently grouped by the PinMAME clone chain: `ph_04`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `ph_04`.
