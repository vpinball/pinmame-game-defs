...
- Candidate root driver: `metalman`
- Candidate manufacturer: Inder (Spain)
- Candidate year: 1992
- Drivers currently grouped by the PinMAME clone chain: `metalman`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `metalman`.
