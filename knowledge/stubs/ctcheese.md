# STUB - Cut The Cheese (Redemption)
...
- Candidate root driver: `ctcheese`
- Candidate manufacturer: Sega
- Candidate year: 1996
- Drivers currently grouped by the PinMAME clone chain: `ctcheese`, `ctchzdlx`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `ctcheese`.
