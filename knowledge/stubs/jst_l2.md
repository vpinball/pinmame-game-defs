...
- Candidate root driver: `jst_l2`
- Candidate manufacturer: Williams
- Candidate year: 1983
- Drivers currently grouped by the PinMAME clone chain: `jst_l1`, `jst_l2`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `jst_l2`.
