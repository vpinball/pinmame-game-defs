...
- Candidate root driver: `mmmaster`
- Candidate manufacturer: ManilaMatic
- Candidate year: 1988
- Drivers currently grouped by the PinMAME clone chain: `mmmaster`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `mmmaster`.
