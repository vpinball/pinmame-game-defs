...
- Candidate root driver: `vector`
- Candidate manufacturer: Bally
- Candidate year: 1982
- Drivers currently grouped by the PinMAME clone chain: `vector`, `vector4`, `vectora`, `vectorb`, `vectorc`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `vector`.
