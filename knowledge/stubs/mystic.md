...
- Candidate root driver: `mystic`
- Candidate manufacturer: Bally
- Candidate year: 1980
- Drivers currently grouped by the PinMAME clone chain: `mystic`, `mysticb`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `mystic`.
