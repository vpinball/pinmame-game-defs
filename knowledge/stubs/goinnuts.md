...
- Candidate root driver: `goinnuts`
- Candidate manufacturer: Gottlieb
- Candidate year: 1983
- Drivers currently grouped by the PinMAME clone chain: `goinnuts`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `goinnuts`.
