...
- Candidate root driver: `biggame`
- Candidate manufacturer: Stern
- Candidate year: 1980
- Drivers currently grouped by the PinMAME clone chain: `biggame`, `biggameb`, `biggamec`, `biggamed`, `biggamee`, `biggamef`, `biggamfp`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `biggame`.
