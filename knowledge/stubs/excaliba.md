...
- Candidate root driver: `excaliba`
- Candidate manufacturer: Gottlieb
- Candidate year: 1988
- Drivers currently grouped by the PinMAME clone chain: `excalbfp`, `excalffp`, `excalgfp`, `excaliba`, `excalibg`, `excalibr`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `excaliba`.
