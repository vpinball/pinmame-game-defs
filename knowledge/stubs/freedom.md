...
- Candidate root driver: `freedom`
- Candidate manufacturer: Bally
- Candidate year: 1976
- Drivers currently grouped by the PinMAME clone chain: `freedom`, `freedoma`, `freedomb`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `freedom`.
