...
- Candidate root driver: `nfl`
- Candidate manufacturer: Stern
- Candidate year: 2001
- Drivers currently grouped by the PinMAME clone chain: `nfl`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `nfl`.
