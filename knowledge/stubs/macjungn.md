...
- Candidate root driver: `macjungn`
- Candidate manufacturer: MAC S.A.
- Candidate year: 1995
- Drivers currently grouped by the PinMAME clone chain: `macjungn`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `macjungn`.
