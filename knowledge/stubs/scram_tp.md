...
- Candidate root driver: `scram_tp`
- Candidate manufacturer: Tecnoplay
- Candidate year: 1987
- Drivers currently grouped by the PinMAME clone chain: `scram_tp`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `scram_tp`.
