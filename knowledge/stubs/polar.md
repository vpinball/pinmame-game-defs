...
- Candidate root driver: `polar`
- Candidate manufacturer: Taito
- Candidate year: 198?
- Drivers currently grouped by the PinMAME clone chain: `polar`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `polar`.
