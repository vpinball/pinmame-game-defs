# STUB - Close Encounters of the Third Kind
...
- Candidate root driver: `closeenc`
- Candidate manufacturer: Gottlieb
- Candidate year: 1978
- Drivers currently grouped by the PinMAME clone chain: `closeenc`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `closeenc`.
