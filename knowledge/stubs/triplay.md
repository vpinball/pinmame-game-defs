...
- Candidate root driver: `triplay`
- Candidate manufacturer: Gottlieb
- Candidate year: 1985
- Drivers currently grouped by the PinMAME clone chain: `triplay`, `triplaya`, `triplayg`, `triplgfp`, `triplyf1`, `triplyfp`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `triplay`.
