# STUB - Midnight Marauders (Gun game)
...
- Candidate root driver: `mdntmrdr`
- Candidate manufacturer: Bally Midway
- Candidate year: 1984
- Drivers currently grouped by the PinMAME clone chain: `mdntmrdr`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `mdntmrdr`.
