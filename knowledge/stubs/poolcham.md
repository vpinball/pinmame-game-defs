...
- Candidate root driver: `poolcham`
- Candidate manufacturer: Zaccaria
- Candidate year: 1985
- Drivers currently grouped by the PinMAME clone chain: `poolcfp`, `poolchai`, `poolchaifp`, `poolcham`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `poolcham`.
