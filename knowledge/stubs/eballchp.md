...
- Candidate root driver: `eballchp`
- Candidate manufacturer: Bally
- Candidate year: 1985
- Drivers currently grouped by the PinMAME clone chain: `eballch2`, `eballchp`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `eballchp`.
