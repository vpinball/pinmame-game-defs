...
- Candidate root driver: `pnkpnthr`
- Candidate manufacturer: Gottlieb
- Candidate year: 1981
- Drivers currently grouped by the PinMAME clone chain: `pnkpnthr`, `pnkpntr7`, `pnkpntrs`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `pnkpnthr`.
