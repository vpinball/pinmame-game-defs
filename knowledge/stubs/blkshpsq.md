...
- Candidate root driver: `blkshpsq`
- Candidate manufacturer: Astro
- Candidate year: 1978
- Drivers currently grouped by the PinMAME clone chain: `blkshpsq`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `blkshpsq`.
