...
- Candidate root driver: `nmoves`
- Candidate manufacturer: International Concepts
- Candidate year: 1989
- Drivers currently grouped by the PinMAME clone chain: `nmoves`, `nmovesfp`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `nmoves`.
