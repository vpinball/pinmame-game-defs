...
- Candidate root driver: `mntecrlo`
- Candidate manufacturer: Gottlieb
- Candidate year: 1987
- Drivers currently grouped by the PinMAME clone chain: `mntcr2fp`, `mntcrafp`, `mntcrffp`, `mntcrfmfp`, `mntcrgfp`, `mntcrgmfp`, `mntcrmfp`, `mntecrfp`, `mntecrl2`, `mntecrla`, `mntecrlf`, `mntecrlg`, `mntecrlga`, `mntecrlo`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `mntecrlo`.
