...
- Candidate root driver: `mars`
- Candidate manufacturer: Gottlieb
- Candidate year: 1981
- Drivers currently grouped by the PinMAME clone chain: `mars`, `mars7`, `mars_2`, `marsf`, `marsp`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `mars`.
