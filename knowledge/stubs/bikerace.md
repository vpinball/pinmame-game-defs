...
- Candidate root driver: `bikerace`
- Candidate manufacturer: Sleic (Spain)
- Candidate year: 1992
- Drivers currently grouped by the PinMAME clone chain: `bikerac2`, `bikerace`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `bikerace`.
