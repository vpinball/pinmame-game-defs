...
- Candidate root driver: `mcastle`
- Candidate manufacturer: Zaccaria
- Candidate year: 1984
- Drivers currently grouped by the PinMAME clone chain: `mcastffp`, `mcastfp`, `mcastgfp`, `mcastifp`, `mcastle`, `mcastlef`, `mcastleg`, `mcastlei`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `mcastle`.
