...
- Candidate root driver: `s80btest`
- Candidate manufacturer: Gottlieb
- Candidate year: 198?
- Drivers currently grouped by the PinMAME clone chain: `s80btest`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `s80btest`.
