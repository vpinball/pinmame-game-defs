...
- Candidate root driver: `antar`
- Candidate manufacturer: Playmatic
- Candidate year: 1979
- Drivers currently grouped by the PinMAME clone chain: `antar`, `antar2`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `antar`.
