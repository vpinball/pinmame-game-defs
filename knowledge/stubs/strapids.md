...
- Candidate root driver: `strapids`
- Candidate manufacturer: Zaccaria
- Candidate year: 1979
- Drivers currently grouped by the PinMAME clone chain: `strapids`, `strapidsf`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `strapids`.
