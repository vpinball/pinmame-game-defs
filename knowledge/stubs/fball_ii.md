...
- Candidate root driver: `fball_ii`
- Candidate manufacturer: Bally
- Candidate year: 1981
- Drivers currently grouped by the PinMAME clone chain: `fball_ia`, `fball_ii`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `fball_ii`.
