...
- Candidate root driver: `sshtlzac`
- Candidate manufacturer: Zaccaria
- Candidate year: 1980
- Drivers currently grouped by the PinMAME clone chain: `sshtlzac`, `sshtlzacf`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `sshtlzac`.
