...
- Candidate root driver: `f1gp`
- Candidate manufacturer: Nuova Bell Games
- Candidate year: 1987
- Drivers currently grouped by the PinMAME clone chain: `f1gp`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `f1gp`.
