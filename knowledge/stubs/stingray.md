...
- Candidate root driver: `stingray`
- Candidate manufacturer: Stern
- Candidate year: 1977
- Drivers currently grouped by the PinMAME clone chain: `stingrab`, `stingray`, `stingrfp`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `stingray`.
