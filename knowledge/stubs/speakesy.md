...
- Candidate root driver: `speakesy`
- Candidate manufacturer: Bally
- Candidate year: 1982
- Drivers currently grouped by the PinMAME clone chain: `speake4a`, `speakes4`, `speakesa`, `speakesy`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `speakesy`.
