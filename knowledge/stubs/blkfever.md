...
- Candidate root driver: `blkfever`
- Candidate manufacturer: Playmatic
- Candidate year: 1980
- Drivers currently grouped by the PinMAME clone chain: `blkfever`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `blkfever`.
