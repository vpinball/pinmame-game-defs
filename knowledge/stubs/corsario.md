...
- Candidate root driver: `corsario`
- Candidate manufacturer: Inder (Spain)
- Candidate year: 1989
- Drivers currently grouped by the PinMAME clone chain: `corsarfp`, `corsario`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `corsario`.
