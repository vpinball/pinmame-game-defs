...
- Candidate root driver: `clas1812`
- Candidate manufacturer: Gottlieb
- Candidate year: 1991
- Drivers currently grouped by the PinMAME clone chain: `beav_butt`, `clas1812`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `clas1812`.
