...
- Candidate root driver: `glxplay`
- Candidate manufacturer: CICPlay
- Candidate year: 1985
- Drivers currently grouped by the PinMAME clone chain: `glxplay`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `glxplay`.
