# STUB - Golden Cue (0.04 Prototype)
...
- Candidate root driver: `goldcue`
- Candidate manufacturer: Sega
- Candidate year: 1998
- Drivers currently grouped by the PinMAME clone chain: `goldcue`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `goldcue`.
