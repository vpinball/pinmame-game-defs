...
- Candidate root driver: `robowars`
- Candidate manufacturer: Gottlieb
- Candidate year: 1988
- Drivers currently grouped by the PinMAME clone chain: `robowarf`, `robowars`, `robowffp`, `robowrfp`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `robowars`.
