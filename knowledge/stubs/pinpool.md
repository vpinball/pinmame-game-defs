...
- Candidate root driver: `pinpool`
- Candidate manufacturer: Gottlieb
- Candidate year: 1979
- Drivers currently grouped by the PinMAME clone chain: `pinpool`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `pinpool`.
