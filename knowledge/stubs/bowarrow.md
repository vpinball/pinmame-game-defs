# STUB - Bow & Arrow (Prototype, rev. 23)
...
- Candidate root driver: `bowarrow`
- Candidate manufacturer: Bally
- Candidate year: 1976
- Drivers currently grouped by the PinMAME clone chain: `bowarroa`, `bowarrow`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `bowarrow`.
