# STUB - Baby Pac-Man (Video/Pinball Combo)
...
- Candidate root driver: `babypac`
- Candidate manufacturer: Bally
- Candidate year: 1982
- Drivers currently grouped by the PinMAME clone chain: `babypac`, `babypaca`, `babypacn`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `babypac`.
