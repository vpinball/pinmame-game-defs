...
- Candidate root driver: `discodan`
- Candidate manufacturer: LTD
- Candidate year: 19??
- Drivers currently grouped by the PinMAME clone chain: `discodan`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `discodan`.
