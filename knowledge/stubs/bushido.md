...
- Candidate root driver: `bushido`
- Candidate manufacturer: Inder/Spinball (Spain)
- Candidate year: 1993
- Drivers currently grouped by the PinMAME clone chain: `bushido`, `bushidoa`, `bushidob`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `bushido`.
