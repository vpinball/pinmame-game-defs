...
- Candidate root driver: `amazonh2`
- Candidate manufacturer: Gottlieb
- Candidate year: 1987
- Drivers currently grouped by the PinMAME clone chain: `amazn2fp`, `amazonh2`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `amazonh2`.
