# STUB - U.S.A. Football (Redemption, P08)
...
- Candidate root driver: `usafootr`
- Candidate manufacturer: Alvin G
- Candidate year: 1994
- Drivers currently grouped by the PinMAME clone chain: `usafootr`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `usafootr`.
