...
- Candidate root driver: `pinchamp`
- Candidate manufacturer: Zaccaria
- Candidate year: 1983
- Drivers currently grouped by the PinMAME clone chain: `pinc7ffp`, `pinc7fp`, `pinc7gfp`, `pinc7ifp`, `pincffp`, `pincfp`, `pincgfp`, `pincha7f`, `pincha7g`, `pincha7i`, `pincham7`, `pinchamf`, `pinchamg`, `pinchami`, `pinchamp`, `pincifp`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `pinchamp`.
