...
- Candidate root driver: `goldball`
- Candidate manufacturer: Bally
- Candidate year: 1983
- Drivers currently grouped by the PinMAME clone chain: `goldbalb`, `goldbalc`, `goldball`, `goldbaln`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `goldball`.
