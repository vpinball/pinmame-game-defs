...
- Candidate root driver: `superman`
- Candidate manufacturer: Atari
- Candidate year: 1979
- Drivers currently grouped by the PinMAME clone chain: `superman`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `superman`.
