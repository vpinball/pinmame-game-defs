...
- Candidate root driver: `cowboy3p`
- Candidate manufacturer: LTD
- Candidate year: 1981
- Drivers currently grouped by the PinMAME clone chain: `cowboy3a`, `cowboy3p`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `cowboy3p`.
