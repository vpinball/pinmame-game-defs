...
- Candidate root driver: `m_mpac`
- Candidate manufacturer: Bally
- Candidate year: 1982
- Drivers currently grouped by the PinMAME clone chain: `m_mpac`, `m_mpaca`, `m_mpacb`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `m_mpac`.
