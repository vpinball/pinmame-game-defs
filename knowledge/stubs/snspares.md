...
- Candidate root driver: `snspares`
- Candidate manufacturer: Gottlieb
- Candidate year: 1995
- Drivers currently grouped by the PinMAME clone chain: `snspare1`, `snspare2`, `snspares`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `snspares`.
