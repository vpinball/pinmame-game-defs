...
- Candidate root driver: `zephy`
- Candidate manufacturer: LTD
- Candidate year: 1982
- Drivers currently grouped by the PinMAME clone chain: `zephy`, `zephya`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `zephy`.
