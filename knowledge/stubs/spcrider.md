...
- Candidate root driver: `spcrider`
- Candidate manufacturer: Atari
- Candidate year: 1978
- Drivers currently grouped by the PinMAME clone chain: `spcridef`, `spcrider`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `spcrider`.
