...
- Candidate root driver: `ckpt_a17`
- Candidate manufacturer: Data East
- Candidate year: 1991
- Drivers currently grouped by the PinMAME clone chain: `ckpt_a17`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `ckpt_a17`.
