...
- Candidate root driver: `bbeltzac`
- Candidate manufacturer: Zaccaria
- Candidate year: 1986
- Drivers currently grouped by the PinMAME clone chain: `bbeltffp`, `bbeltgfp`, `bbeltifp`, `bbeltzac`, `bbeltzaf`, `bbeltzag`, `bbeltzai`, `bbeltzfp`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `bbeltzac`.
