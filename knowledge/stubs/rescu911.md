...
- Candidate root driver: `rescu911`
- Candidate manufacturer: Gottlieb
- Candidate year: 1994
- Drivers currently grouped by the PinMAME clone chain: `rescu911`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `rescu911`.
