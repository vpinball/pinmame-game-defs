...
- Candidate root driver: `suprbowl`
- Candidate manufacturer: Bell Games
- Candidate year: 1984
- Drivers currently grouped by the PinMAME clone chain: `sprbwlfp`, `suprbowl`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `suprbowl`.
