...
- Candidate root driver: `kpb105`
- Candidate manufacturer: Capcom
- Candidate year: 1996
- Drivers currently grouped by the PinMAME clone chain: `kpb105`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `kpb105`.
