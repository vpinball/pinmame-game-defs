...
- Candidate root driver: `iomoon`
- Candidate manufacturer: Sleic (Spain)
- Candidate year: 1994
- Drivers currently grouped by the PinMAME clone chain: `iomoon`
...
- PinMAME `4ec52ff0ac133ac251681518aed2249e19fe26eb`, public `PinmameGetGames` catalog entry for `iomoon`.
