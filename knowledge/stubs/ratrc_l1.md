...
- Candidate root driver: `ratrc_l1`
- Candidate manufacturer: Williams
- Candidate year: 1983
- Drivers currently grouped by the PinMAME clone chain: `ratrc_l1`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `ratrc_l1`.
