...
- Candidate root driver: `sprk_103`
- Candidate manufacturer: Sega
- Candidate year: 1999
- Drivers currently grouped by the PinMAME clone chain: `sprk_090`, `sprk_096`, `sprk_103`
...
- PinMAME `8371478a7640f1896dcdf565aed340dc5df989ba`, public `PinmameGetGames` catalog entry for `sprk_103`.
