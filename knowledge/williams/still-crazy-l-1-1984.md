# Still Crazy (L-1) (Williams 1984)

Coverage: **partial - machine identity only. Nothing about playfield devices, wiring, mechanisms,
or behavior is evidenced yet.**

This record was promoted from the generated catalog stub `stub.pinmame.scrzy_l1` by the
...
- PinMAME catalog: root driver `scrzy_l1`, description "Still Crazy (L-1)", manufacturer
...
- The definition's driver list is exactly the clone tree PinMAME declares under `scrzy_l1`;
