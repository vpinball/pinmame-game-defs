# Alley Cats (Shuffle) (L-7) (Williams 1985)

Coverage: **partial - machine identity only. Nothing about playfield devices, wiring, mechanisms,
or behavior is evidenced yet.**

This record was promoted from the generated catalog stub `stub.pinmame.alcat_l7` by the
...
- PinMAME catalog: root driver `alcat_l7`, description "Alley Cats (Shuffle) (L-7)", manufacturer
...
- The definition's driver list is exactly the clone tree PinMAME declares under `alcat_l7`;
