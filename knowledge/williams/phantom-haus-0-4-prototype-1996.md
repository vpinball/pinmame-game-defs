# Phantom Haus (0.4 Prototype) (Williams 1996)

Coverage: **partial - machine identity only. Nothing about playfield devices, wiring, mechanisms,
or behavior is evidenced yet.**

This record was promoted from the generated catalog stub `stub.pinmame.ph_04` by the
...
- PinMAME catalog: root driver `ph_04`, description "Phantom Haus (0.4 Prototype)", manufacturer
...
- The definition's driver list is exactly the clone tree PinMAME declares under `ph_04`;
