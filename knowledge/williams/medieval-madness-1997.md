...
Legacy evidence identifies this candidate as Williams (1997). The information below is preserved for recreation work but is not automatically treated as validated physical-machine fact.
...
- `legacy.game.mm`: `games/mm.json` at the pinned migration revision.
