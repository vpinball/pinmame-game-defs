...
This record was promoted from the generated catalog stub `stub.pinmame.blkholea` by the
...
- `blkhol7s` (2008, Oliver, clone of `blkholea`).
- `blkholea` (1981, Gottlieb, clone of `gts80s`).
