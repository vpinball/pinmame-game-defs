# Nudge It (Gottlieb 1990)

Coverage: **partial - machine identity plus candidate-only I/O attachments. Playfield devices,
wiring, mechanisms, and behavior are evidenced only as unverified candidates.**

This record was promoted from the generated catalog stub `stub.pinmame.nudgeit` by the
...
- PinMAME catalog: root driver `nudgeit`, description "Nudge It", manufacturer
...
- The definition's driver list is exactly the clone tree PinMAME declares under `nudgeit`;
  whether every listed driver really runs on this physical machine is unverified.

## Drivers this record holds

- `nudgeit` (1990, Gottlieb).
