...
This record was promoted from the generated catalog stub `stub.pinmame.caveman` by the
...
- `caveman` (1981, Gottlieb, clone of `gts80a`).
- `cavemana` (1981, Gottlieb, clone of `caveman`).
- `cavemane` (1981, Flipprojets, clone of `caveman`).
