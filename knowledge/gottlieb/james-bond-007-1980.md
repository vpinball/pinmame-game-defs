...
This record was promoted from the generated catalog stub `stub.pinmame.jamesb` by the
...
- `jamesb` (1980, Gottlieb, clone of `gts80s`).
- `jamesb2` (1980, Gottlieb, clone of `jamesb`).
- `jamesb7` (2008, Oliver, clone of `jamesb`).
- `jamesb7b` (2008, Oliver, clone of `jamesb`).
