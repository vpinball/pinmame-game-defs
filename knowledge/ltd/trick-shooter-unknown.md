# Trick Shooter (LTD year unknown)

Coverage: **partial - machine identity only. Nothing about playfield devices, wiring, mechanisms,
or behavior is evidenced yet.**

This record was promoted from the generated catalog stub `stub.pinmame.tricksht` by the
...
- PinMAME catalog: root driver `tricksht`, description "Trick Shooter", manufacturer
...
- The definition's driver list is exactly the clone tree PinMAME declares under `tricksht`;
