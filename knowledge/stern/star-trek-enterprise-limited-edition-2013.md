...
Legacy evidence identifies this candidate as Stern (2013). The information below is preserved for recreation work but is not automatically treated as validated physical-machine fact.
...
- `legacy.game.star-trek-stern`: `games/star-trek-stern.json` at the pinned migration revision.
