...
- The pinned PinMAME source declares `stars` at `src/wpc/stgames.c:100` with machine module `by35_mST100`; no reviewed profile covers that module yet, so no platform is declared.
