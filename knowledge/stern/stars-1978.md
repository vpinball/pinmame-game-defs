...
- The pinned PinMAME source declares `stars` at `src/wpc/stgames.c:100` with machine module `by35_mST100`; the definition declares controller platform `pinmame.stern-mpu200` from it.
