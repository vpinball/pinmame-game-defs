...
- The pinned PinMAME source declares `princess` at `src/wpc/stgames.c:318` with machine module `by35_mST100bs`; no reviewed profile covers that module yet, so no platform is declared.
