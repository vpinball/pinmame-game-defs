...
- The pinned PinMAME source declares `dracula` at `src/wpc/stgames.c:211` with machine module `by35_mST100s`; no reviewed profile covers that module yet, so no platform is declared.
