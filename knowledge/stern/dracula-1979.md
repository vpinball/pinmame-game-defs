...
- The pinned PinMAME source declares `dracula` at `src/wpc/stgames.c:211` with machine module `by35_mST100s`; the definition declares controller platform `pinmame.stern-mpu200` from it.
