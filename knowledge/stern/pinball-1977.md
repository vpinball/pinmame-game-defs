...
- The pinned PinMAME source declares `pinball` at `src/wpc/stgames.c:54` with machine module `by35_mST100`; the definition declares controller platform `pinmame.stern-mpu200` from it.
