...
- The pinned PinMAME source declares `wildfyre` at `src/wpc/stgames.c:169` with machine module `by35_mST100s`; the definition declares controller platform `pinmame.stern-mpu200` from it.
