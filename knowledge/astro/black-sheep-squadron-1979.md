...
- The pinned PinMAME source declares `blkshpsq` at `src/wpc/stgames.c:32` with machine module `by35_mST100`; no platform is declared (no reviewed profile covers that module yet).
