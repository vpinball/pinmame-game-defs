# Lap By Lap (Inder (Spain) 1986)

Coverage: **partial - machine identity only. Nothing about playfield devices, wiring, mechanisms,
or behavior is evidenced yet.**

This record was promoted from the generated catalog stub `stub.pinmame.lapbylap` by the
...
- PinMAME catalog: root driver `lapbylap`, description "Lap By Lap", manufacturer
...
- The definition's driver list is exactly the clone tree PinMAME declares under `lapbylap`;
  whether every listed driver really runs on this physical machine is unverified.

## Drivers this record holds

- `lapbylap` (1986, Inder (Spain)).
- `lapbylfp` (1986, Inder (Spain), clone of `lapbylap`).
