# Corsario (Inder (Spain) 1989)

Coverage: **partial - machine identity plus candidate-only I/O attachments. Playfield devices,
wiring, mechanisms, and behavior are evidenced only as unverified candidates.**

This record was promoted from the generated catalog stub `stub.pinmame.corsario` by the
...
- PinMAME catalog: root driver `corsario`, description "Corsario", manufacturer
  "Inder (Spain)", catalog year "1989".
...
- The definition's driver list is exactly the clone tree PinMAME declares under `corsario`;
  whether every listed driver really runs on this physical machine is unverified.

## Drivers this record holds

- `corsarfp` (1989, Inder (Spain), clone of `corsario`).
- `corsario` (1989, Inder (Spain)).
