...
This record was promoted from the generated catalog stub `stub.pinmame.drakor` by the
...
- PinMAME catalog: root driver `drakor`, description "Drakor", manufacturer
...
- The definition's driver list is exactly the clone tree PinMAME declares under `drakor`;
