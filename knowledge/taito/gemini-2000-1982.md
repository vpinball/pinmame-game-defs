# Gemini 2000 (Taito 1982)

Coverage: **partial - machine identity only. Nothing about playfield devices, wiring, mechanisms,
or behavior is evidenced yet.**

This record was promoted from the generated catalog stub `stub.pinmame.gemini` by the
...
- PinMAME catalog: root driver `gemini`, description "Gemini 2000", manufacturer
...
- The definition's driver list is exactly the clone tree PinMAME declares under `gemini`;
  whether every listed driver really runs on this physical machine is unverified.

## Drivers this record holds

- `gemini` (1982, Taito).
- `gemini1` (1982, Taito, clone of `gemini`).
