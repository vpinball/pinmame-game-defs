...
This record was promoted from the generated catalog stub `stub.pinmame.sureshot` by the
...
- PinMAME catalog: root driver `sureshot`, description "Sure Shot", manufacturer
...
- The definition's driver list is exactly the clone tree PinMAME declares under `sureshot`;
