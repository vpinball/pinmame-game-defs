# Lady Luck (Taito) (Taito 1981)

Coverage: **partial - machine identity only. Nothing about playfield devices, wiring, mechanisms,
or behavior is evidenced yet.**

This record was promoted from the generated catalog stub `stub.pinmame.ladylukt` by the
...
- PinMAME catalog: root driver `ladylukt`, description "Lady Luck (Taito)", manufacturer
...
- The definition's driver list is exactly the clone tree PinMAME declares under `ladylukt`;
  whether every listed driver really runs on this physical machine is unverified.

## Drivers this record holds

- `ladylukt` (1981, Taito).
- `vegast` (198?, Taito, clone of `ladylukt`).
