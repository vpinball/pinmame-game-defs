...
- **controller_platform** — `pinmame.dataeast`: The physical Data East CPU/driver board family shares emulator code with System 11, but no reviewed Data East controller profile exists. Would resolve: A reviewed pinmame.dataeast controller profile derived from pinned source and original Data East board documentation.
