...
- **polarity** — `coil.driver-45`, `coil.driver-46`, `coil.driver-47`, `coil.driver-48`: The synthetic power/hold states have no settled winding-level mapping, and the right callback combines lower and upper flippers. Switches 30/31 are no longer part of this question: core_updateSw rewrites both from the cabinet-button bits at public 82/84 on every update, so the ROM reads them exactly as a consumer writes 82/84. Would resolve: Bench capture of the flipper windings and public power/hold outputs on an original machine or faithful PinMAME harness.
