...
Status: Implementation in progress (2026-08-04, 60%), based on the Opus-reviewed architecture and the discussion in [pinmame-game-defs PR #1](https://github.com/vpinball/pinmame-game-defs/pull/1). The physical-only cleanup was approved and committed at `e53d7c7`, the Ali physical-family correction at `59bf6bb`, AC/DC Vault Edition at `252c740`, Spider-Man Vault Edition at `c4568f5`, AC/DC LED Pro at `2a16295`, the Simpsons Pinball Party IPDB identity correction at `441527b`, The Walking Dead Premium/LE at `5e89ad4`, The Walking Dead Pro at `31e8902`, Iron Man Pro Vault Edition at `d5d585a`, Mustang Premium/LE/Boss at `9630e18`, Mustang Pro at `3c875af`, Star Trek Premium/LE at `2e1de79`, Star Trek Pro at `4b224ec`, and the Star Trek Premium trough correction at `3ce4591`. Metallica Premium/LE is the eleventh author-ready definition in the review-ready working tree. The remaining 22 semantic baselines stay fail-closed until each has reviewed coordinate evidence; Terminator 2 remains deferred until all 33 spatial retrofits are complete.
...
The RFC/validator vertical slice, catalog generator, legacy import, two-corpus VPX extraction, organized manual acquisition/extraction, ROM corpus indexer, and DMD-capable reusable LibPinMAME service/gameplay harness are implemented. The Ali identity correction plus AC/DC Vault, Spider-Man Vault, AC/DC LED Pro, The Walking Dead Premium/LE, The Walking Dead Pro, Iron Man Pro Vault, Mustang Premium/LE/Boss, Mustang Pro, Star Trek Premium/LE, and Star Trek Pro spatial retrofits are committed. TSPP's incorrect IPDB 6154 identity was traced to a bad third-party VPX header, corrected to 4674, and committed at `441527b` without altering pinned/generated third-party evidence. Metallica Premium/LE is the eleventh author-ready definition in the review-ready tree; the other 22 semantic baselines remain fail-closed for spatial placement. The next work package is ordered as follows:

1. Complete Metallica Premium/LE with repository-wide gates, a fresh Opus review, and a dedicated commit, then process Metallica Pro and the remaining partial physical games newest-first; preserve fail-closed status until each title has reviewed coordinate evidence and a fresh Opus-reviewed commit, process Ali's spatial work later at 1980, and finish all 22 remaining pending records before Terminator 2.
