...
Status: Implementation in progress (2026-08-04, 67%), based on the Opus-reviewed architecture and the discussion in [pinmame-game-defs PR #1](https://github.com/vpinball/pinmame-game-defs/pull/1). The physical-only cleanup was approved and committed at `e53d7c7`, the Ali physical-family correction at `59bf6bb`, AC/DC Vault Edition at `252c740`, Spider-Man Vault Edition at `c4568f5`, AC/DC LED Pro at `2a16295`, the Simpsons Pinball Party IPDB identity correction at `441527b`, The Walking Dead Premium/LE at `5e89ad4`, The Walking Dead Pro at `31e8902`, Iron Man Pro Vault Edition at `d5d585a`, Mustang Premium/LE/Boss at `9630e18`, Mustang Pro at `3c875af`, Star Trek Premium/LE at `2e1de79`, Star Trek Pro at `4b224ec`, the Star Trek Premium trough correction at `3ce4591`, Metallica Premium/LE at `4d730ab`, Metallica Pro at `c00a0c2`, original AC/DC Pro at `96bacc8`, AC/DC Premium/LE/LUCI at `411fd11`, Avengers Pro at `998a7b3`, Rolling Stones Standard at `796f7b5`, the fail-closed X-Men Limited Edition spatial-evidence pass at `5c81305`, Rolling Stones Limited Edition at `b981bf2`, the Avengers Limited Edition conflict pass at `338be40`, the Stern 24 blocker pass at `0ba503a`, the Transformers Limited Edition fail-closed pass at `9b3bf05`, and TRON: Legacy Limited Edition at `bbb6e0d`. Avatar LE is integrated at `dbdfd9c`, the original Spider-Man (Stern 2007) at `8c4f321`, and Terminator 2 at `c0d91e8` from the literal-Opus-approved per-game commit `6f3f3b0`. The combined Terminator 2 tree received a second literal Opus approval, was committed to local `master`, and its clean game worktree was removed. Terminator 2 remains conspicuously partial rather than receiving completion credit because four physical/electrical conflicts are unresolved. The original Iron Man 2010 now passes repository validation as a twentieth author-ready definition after manual-reconciled shared-layout promotion; its exact tree is awaiting Opus approval before commit. Fourteen definitions now report missing spatial placement. The immediate wrap-up queue is the already-started Avatar Pro, Transformers Pro, TRON Pro, and X-Men Pro work, after which all reviewed work is consolidated into the root `master` checkout and this run pauses.

## Implementation status

| Workstream | Status | Current result |
| --- | --- | --- |
| Repository state and historical ledger | Complete | Historical spatial retrofit commits remain recorded in the status ledger above; current work must remain reviewable and fail-closed until its own validation and review gates pass. |
...
| Author-ready definitions | In progress | The pinned public API returns 2,873 drivers; seven custom-ROM-only virtual-table drivers are excluded, leaving 2,866 in-scope drivers grouped into 785 physical-game records plus one explicitly classified non-game diagnostic. AC/DC Vault, Spider-Man Vault, original Spider-Man (Stern 2007), AC/DC LED Pro, The Walking Dead Premium/LE, The Walking Dead Pro, Iron Man Pro Vault, original Iron Man 2010, Mustang Premium/LE/Boss, Mustang Pro, Star Trek Premium/LE, Star Trek Pro, Metallica Premium/LE, Metallica Pro, original AC/DC Pro, AC/DC Premium/LE/LUCI, Avengers Pro, Rolling Stones Standard, Rolling Stones Limited Edition, TRON: Legacy Limited Edition, and Avatar LE are complete in the current validated tree. The regenerated catalog yields 20/785 author-ready games, 82 partial games, 683 conspicuous game stubs, and 14 records that explicitly report missing spatial placement; Scott's diagnostic is separately partial and excluded from the denominator. Terminator 2 now has a complete controller inventory, semantic mapping, retained recreation knowledge, and source-backed spatial evidence, but remains one of the partials because author-critical conflicts are unresolved. |
...
| Recreation knowledge | In progress | A conspicuous stub note exists for every unresolved root. Terminator 2 now documents the four-switch trough order and roles, shooter, locks, single drop target, gun traverse and position windows, firing causality, kickback, slings, bumpers, flippers, exact lamp and effect placement, evidence authority, and the four unresolved physical conflicts; its generator and regression test keep the recreation prose synchronized with the known-working script. Complete source-linked Ripley's notes and earlier detailed product notes remain unchanged. |
| Static catalog site | Complete; deployment blocked externally | The external `pinmame-games` source is copied into `site/`, the Node 22 Pages build is verified, Opus-reviewed commits `9d205ff` and `8c7bbd9` are pushed on `master`, and the custom domain is configured in source. GitHub rejects Pages activation because the repository is private under a plan that does not support private Pages. Once the repository is public or the plan supports private Pages, configure `games.visualpinball.org` and point its CNAME to `vpinball.github.io`. |
| Continuation runbook | Complete locally; intentionally uncommitted | The user finished `INSTRUCTIONS.md` and explicitly requested that it not be committed. It covers the full evidence, model-routing, per-game, Opus-review, integration, cleanup, publication, harness, and Ghidra workflow. The byte-preserved file will be copied into the requested root checkout as an uncommitted local file before its auxiliary worktree is retired. |
...
| Validation and Opus review | In progress | The physical-only cleanup, Ali correction, AC/DC Vault, Spider-Man Vault, AC/DC LED Pro, TSPP identity correction, Walking Dead Premium/LE, Walking Dead Pro, Iron Man Pro Vault, Mustang Premium/LE/Boss, Mustang Pro, Star Trek Premium/LE, Star Trek Pro, the corrective Star Trek Premium trough/Q22 pass, Metallica Premium/LE, Metallica Pro, original AC/DC Pro, AC/DC Premium/LE/LUCI, Avengers Pro, Rolling Stones Standard, X-Men LE's fail-closed spatial-evidence pass, Avengers LE's fail-closed spatial-conflict pass, Rolling Stones Limited Edition, 24's fail-closed blocker pass, Transformers LE's fail-closed exact-evidence pass, TRON: Legacy Limited Edition, Avatar LE, Spider-Man 2007, and Terminator 2 received literal Opus approval before their per-game commits. T2's corrected exact tree `e1e1161b` received literal approval and became commit `6f3f3b0`, then the reconciled integration tree `f3e15c2b` passed the second literal review and became `master` commit `c0d91e8`. Iron Man 2010 now passes repository validation plus 57 focused tests, and its final exact tree is the next Opus gate. Work on X-Men Pro, Transformers Pro, TRON Pro, and Avatar Pro remains preserved in isolated worktrees and will be finished before consolidation. Every per-game commit remains gated by a fresh literal Opus `APPROVED` on its exact staged tree, followed by a separate review of any conflict-resolved integration tree before its integration commit. |

### Spatial retrofit sequence

The canonical `playfield` space is defined globally once: normalized VPX/player view with x=0 at left, x=1 at right, y=0 at the rear/backglass end, and y=1 at the front/apron end. Per-machine `physical.location` is construction prose only; it must never be converted into a coordinate automatically. The extractor emits candidate object centers and their source hash, not semantic mappings or canonical placements. Each reviewed title promotes its own explicit sensor/effect/emitter placements with provenance, and GI/flasher/lamp circuits enumerate their individual emitters. TRON: Legacy Limited Edition uses an exact retained LE VPX locked to IPDB 5707/`trn_174h`; the known-working script controls runtime semantics, the official manual controls physical wiring, and their Q19/Q25 dome-direction disagreement remains explicit instead of being silently collapsed.

Acquire table candidates in this order: the configured primary local Tables directory, the configured local Tables Archive, `vpuniverse.com`, then `vpforums.org`. The local inventory finds title candidates in a primary folder for 31 of the 33 records, archive-only fallbacks for two, and records that still require edition disambiguation. The Ali identity correction is complete; its spatial retrofit remains at the 1980 physical-machine position. Spatial retrofit proceeds by physical release year, newest first, one Opus-reviewed commit per title/game, with each active game isolated in its own worktree so review does not block discovery or implementation of the next game; completed worktrees are removed immediately after reviewed integration. AC/DC Vault Edition (2018), Spider-Man Vault Edition (2016), AC/DC LED Pro (2014), The Walking Dead Premium/LE (2014), The Walking Dead Pro (2014), Iron Man Pro Vault Edition (2014), original Iron Man (2010), Mustang Premium/LE/Boss (2014), Mustang Pro (2014), Star Trek Premium/LE (2013), Star Trek Pro (2013), Metallica Premium/LE (2013), Metallica Pro (2013), original AC/DC Pro (2012), AC/DC Premium/LE/LUCI (2012), Avengers Pro (2012), Rolling Stones Standard (2011), Rolling Stones Limited Edition (2011), TRON: Legacy Limited Edition (2011), Avatar LE (2009), and the original Spider-Man (Stern 2007) are author-ready. X-Men Limited Edition (2012), Avengers Limited Edition (2012), Transformers Limited Edition (2011), Stern 24 (2009), and Terminator 2 (1991) remain conspicuous fail-closed partials with concrete evidence or mechanism blockers. The regenerated coverage report contains 14 definitions that explicitly report missing spatial placement. T2's dedicated pass is integrated on `master`; the already-started Pro worktrees are now the bounded wrap-up queue, and no further games will be started before consolidation and pause.
...
The RFC/validator vertical slice, catalog generator, legacy import, two-corpus VPX extraction, organized manual acquisition/extraction, ROM corpus indexer, and DMD-capable reusable LibPinMAME service/gameplay harness are implemented. The Ali identity correction plus AC/DC Vault, Spider-Man Vault, the original Spider-Man (Stern 2007), AC/DC LED Pro, The Walking Dead Premium/LE, The Walking Dead Pro, Iron Man Pro Vault, Mustang Premium/LE/Boss, Mustang Pro, Star Trek Premium/LE, Star Trek Pro, Metallica Premium/LE, Metallica Pro, original AC/DC Pro, AC/DC Premium/LE/LUCI, Avengers Pro, Rolling Stones Standard, Rolling Stones Limited Edition, TRON: Legacy Limited Edition, and Avatar LE spatial retrofits are complete in the current tree. TSPP's incorrect IPDB 6154 identity was traced to a bad third-party VPX header, corrected to 4674, and committed at `441527b` without altering pinned/generated third-party evidence. X-Men Limited Edition, Avengers Limited Edition, Transformers Limited Edition, Stern 24, and Terminator 2 remain spatially documented but partial while their explicit authoring blockers are unresolved. Fifteen definitions explicitly report missing spatial placement; this count includes processed fail-closed games and is not a count of untouched work items. Mechanical VPX extraction now produces compact per-game evidence packets for controller-address candidates, exact coordinates, multiplicity, and unresolved records; sibling editions reuse a family base plus explicit edition overlays, while root review remains mandatory for manual/script conflicts and custom mechanisms. The next work package is ordered as follows:

1. Import, review, publish, and verify the static site from local `master` at `c0d91e8`. Terminator 2's combined review, integration commit, and clean-worktree removal are complete. Preserve the existing X-Men Pro, Transformers Pro, TRON Pro, Avatar Pro, and Iron Man 2010 worktrees without beginning further Pro searches, then resume the remaining non-Pro partials newest-first.
...
5. Finish the user-edited continuation runbook through its separate Opus and integration gates; copy and verify the static catalog site without transient build artifacts, obtain separate Opus approval, configure the custom domain, push local `master` to the remote default `master`, and verify GitHub Pages before reporting the DNS target.
