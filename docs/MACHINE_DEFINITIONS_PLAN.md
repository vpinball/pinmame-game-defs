...
Status: Implementation in progress (2026-08-04, 60%), based on the Opus-reviewed architecture and the discussion in [pinmame-game-defs PR #1](https://github.com/vpinball/pinmame-game-defs/pull/1). The physical-only cleanup was approved and committed at `e53d7c7`, the Ali physical-family correction at `59bf6bb`, AC/DC Vault Edition at `252c740`, Spider-Man Vault Edition at `c4568f5`, AC/DC LED Pro at `2a16295`, the Simpsons Pinball Party IPDB identity correction at `441527b`, The Walking Dead Premium/LE at `5e89ad4`, The Walking Dead Pro at `31e8902`, Iron Man Pro Vault Edition at `d5d585a`, and Mustang Premium/LE/Boss at `9630e18`. Mustang Pro is the eighth author-ready definition in the review-ready working tree. The remaining 25 semantic baselines stay fail-closed until each has reviewed coordinate evidence; Terminator 2 remains deferred until all 33 spatial retrofits are complete.
...
| Author-ready definitions | In progress | The pinned public API returns 2,873 drivers; seven custom-ROM-only virtual-table drivers are excluded, leaving 2,866 in-scope drivers grouped into 785 physical-game records plus one explicitly classified non-game diagnostic. AC/DC Vault, Spider-Man Vault, AC/DC LED Pro, The Walking Dead Premium/LE, The Walking Dead Pro, Iron Man Pro Vault, and Mustang Premium/LE/Boss are committed; Mustang Pro is the eighth author-ready definition in the review-ready tree. The regenerated catalog yields 8/785 author-ready games, 94 partial games, 683 conspicuous game stubs, and 25 remaining spatial retrofits; Scott's diagnostic is separately partial and excluded from the denominator. |
...
| Validation and Opus review | In progress | The physical-only cleanup, Ali correction, AC/DC Vault, Spider-Man Vault, AC/DC LED Pro, TSPP identity correction, Walking Dead Premium/LE, Walking Dead Pro, Iron Man Pro Vault, and Mustang Premium/LE/Boss were approved and committed. Mustang Pro now has complete device dispositions, manual-versus-script trough and switch-49/50 conflict handling, the corrected 43/44/45/49/80 standard-lamp sequence, one manual-proven orbit-post assembly with two VPT collision elements, all 32 physical GI emitters, exact-table source hashing, visual overlay inspection, and deterministic regeneration; its fresh exact-tree Opus gate remains active. Every per-game commit remains gated by a fresh literal Opus `APPROVED` on the exact tree. |
...
The RFC/validator vertical slice, catalog generator, legacy import, two-corpus VPX extraction, organized manual acquisition/extraction, ROM corpus indexer, and DMD-capable reusable LibPinMAME service/gameplay harness are implemented. The Ali identity correction plus AC/DC Vault, Spider-Man Vault, AC/DC LED Pro, The Walking Dead Premium/LE, The Walking Dead Pro, Iron Man Pro Vault, and Mustang Premium/LE/Boss spatial retrofits are committed. TSPP's incorrect IPDB 6154 identity was traced to a bad third-party VPX header, corrected to 4674, and committed at `441527b` without altering pinned/generated third-party evidence. Mustang Pro is the eighth author-ready definition in the review-ready tree; the other 25 semantic baselines remain fail-closed for spatial placement. The next work package is ordered as follows:

1. Complete the fresh Opus gate and per-game commit for Mustang Pro, then resume the remaining partial physical games newest-first; preserve fail-closed status until each title has reviewed coordinate evidence and a fresh Opus-reviewed commit, process Ali's spatial work later at 1980, and finish all 25 remaining pending records before Terminator 2.
