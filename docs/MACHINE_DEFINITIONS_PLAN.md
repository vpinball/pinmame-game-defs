...
The RFC/validator vertical slice, catalog generator, legacy import, two-corpus VPX extraction, organized manual acquisition/extraction, ROM corpus indexer, and DMD-capable reusable LibPinMAME service/gameplay harness are implemented. The Ali identity correction plus AC/DC Vault, Spider-Man Vault, AC/DC LED Pro, The Walking Dead Premium/LE, The Walking Dead Pro, Iron Man Pro Vault, Mustang Premium/LE/Boss, Mustang Pro, Star Trek Premium/LE, Star Trek Pro, Metallica Premium/LE, Metallica Pro, original AC/DC Pro, AC/DC Premium/LE/LUCI, Avengers Pro, Rolling Stones Standard, Rolling Stones Limited Edition, and TRON: Legacy Limited Edition spatial retrofits are complete in the current tree. TSPP's incorrect IPDB 6154 identity was traced to a bad third-party VPX header, corrected to 4674, and committed at `441527b` without altering pinned/generated third-party evidence. X-Men Limited Edition, Avengers Limited Edition, Transformers Limited Edition, and Stern 24 remain spatially documented but partial while their explicit authoring blockers are unresolved. Fifteen semantic baselines remain fail-closed for spatial placement. Mechanical VPX extraction now produces compact per-game evidence packets for controller-address candidates, exact coordinates, multiplicity, and unresolved records; sibling editions reuse a family base plus explicit edition overlays, while root review remains mandatory for manual/script conflicts and custom mechanisms. The next work package is ordered as follows:

1. Complete the already-active Avatar LE, Spider-Man 2007, and Ripley's non-Pro lanes through their review and integration gates, preserve the existing X-Men Pro, Transformers Pro, TRON Pro, Avatar Pro, and Iron Man 2010 worktrees without beginning further Pro searches, then process Terminator 2 as the next dedicated game before resuming the remaining non-Pro partials newest-first.
