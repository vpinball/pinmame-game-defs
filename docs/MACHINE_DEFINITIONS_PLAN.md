...
Status: Implementation in progress (2026-08-03, 57%), based on the Opus-reviewed architecture and the discussion in [pinmame-game-defs PR #1](https://github.com/vpinball/pinmame-game-defs/pull/1). The physical-only cleanup was approved and committed at `e53d7c7`, the Ali physical-family correction at `59bf6bb`, AC/DC Vault Edition at `252c740`, Spider-Man Vault Edition at `c4568f5`, AC/DC LED Pro at `2a16295`, the Simpsons Pinball Party IPDB identity correction at `441527b`, and The Walking Dead Premium/LE at `5e89ad4`. The Walking Dead Pro is locally author-ready; its first Opus review found one bad borrowed-table flasher coordinate and over-broad coordinate provenance, both are corrected, and mandatory correction approval remains pending before commit. The remaining 28 semantic baselines stay fail-closed until each has reviewed coordinate evidence; Terminator 2 remains deferred until all 33 spatial retrofits are complete.
...
| Author-ready definitions | In progress | The pinned public API returns 2,873 drivers; seven custom-ROM-only virtual-table drivers are excluded, leaving 2,866 in-scope drivers grouped into 785 physical-game records plus one explicitly classified non-game diagnostic. AC/DC Vault, Spider-Man Vault, AC/DC LED Pro, and The Walking Dead Premium/LE are committed; The Walking Dead Pro is locally implemented and awaiting Opus review. The regenerated catalog yields 5/785 author-ready games, 97 partial games, 683 conspicuous game stubs, and 28 remaining spatial retrofits; Scott's diagnostic is separately partial and excluded from the denominator. |
...
| Validation and Opus review | In progress | The physical-only cleanup, Ali correction, AC/DC Vault, Spider-Man Vault, AC/DC LED Pro, TSPP identity correction, and Walking Dead Premium/LE were approved and committed. Walking Dead Pro now passes 244 full-suite tests, repository validation, compileall, diff checking, exact spatial dispositions, 33 GI and ten flasher-emitter reconciliation, and deterministic regeneration (SHA-256 `b1ccc5eabbbc3807b784fe8fcf407964799fd319ef7500fdec759593273fdc33` three times). Its first review findings are corrected; literal Opus correction approval is pending and remains a hard pre-commit gate. |
...
The RFC/validator vertical slice, catalog generator, legacy import, two-corpus VPX extraction, organized manual acquisition/extraction, ROM corpus indexer, and DMD-capable reusable LibPinMAME service/gameplay harness are implemented. The Ali identity correction plus AC/DC Vault, Spider-Man Vault, AC/DC LED Pro, and The Walking Dead Premium/LE spatial retrofits are committed. TSPP's incorrect IPDB 6154 identity was traced to a bad third-party VPX header, corrected to 4674, and committed at `441527b` without altering pinned/generated third-party evidence. The Walking Dead Pro spatial retrofit is locally complete and awaiting its mandatory fresh Opus approval; the other 28 semantic baselines remain fail-closed for spatial placement. The next work package is ordered as follows:

1. Obtain fresh Opus approval for The Walking Dead Pro (2014), correct any findings, and commit that game alone.
2. Resume the partial-game queue newest physical release first with Iron Man Pro Vault Edition (2014), then Mustang Premium/LE/Boss and Mustang Pro; preserve fail-closed status until each title has reviewed coordinate evidence and a fresh Opus-reviewed commit, process Ali's spatial work later at 1980, and finish all 28 remaining pending records before Terminator 2.
...
5. After the spatial retrofits, add stable machine-family identifiers and researched prose for edition differences without grouping unrelated physical titles merely because they share a theme.
6. After Terminator 2, copy and verify the static catalog site, obtain its separate Opus approval, and deploy it to GitHub Pages.
7. Keep schema validation, exact catalog reachability, coverage reporting, and regression tests green after every curation batch; no game is committed before its own fresh Opus approval.
