...
Status: Implementation in progress (2026-08-03, 59%), based on the Opus-reviewed architecture and the discussion in [pinmame-game-defs PR #1](https://github.com/vpinball/pinmame-game-defs/pull/1). The physical-only cleanup was approved and committed at `e53d7c7`, the Ali physical-family correction at `59bf6bb`, AC/DC Vault Edition at `252c740`, Spider-Man Vault Edition at `c4568f5`, AC/DC LED Pro at `2a16295`, the Simpsons Pinball Party IPDB identity correction at `441527b`, The Walking Dead Premium/LE at `5e89ad4`, The Walking Dead Pro at `31e8902`, and Iron Man Pro Vault Edition at `d5d585a`. Mustang Premium/LE/Boss is the seventh author-ready definition in this tree. The remaining 26 semantic baselines stay fail-closed until each has reviewed coordinate evidence; Terminator 2 remains deferred until all 33 spatial retrofits are complete.
...
| Author-ready definitions | In progress | The pinned public API returns 2,873 drivers; seven custom-ROM-only virtual-table drivers are excluded, leaving 2,866 in-scope drivers grouped into 785 physical-game records plus one explicitly classified non-game diagnostic. AC/DC Vault, Spider-Man Vault, AC/DC LED Pro, The Walking Dead Premium/LE, The Walking Dead Pro, and Iron Man Pro Vault are committed; Mustang Premium/LE/Boss is the seventh author-ready definition in this tree. The regenerated catalog yields 7/785 author-ready games, 95 partial games, 683 conspicuous game stubs, and 26 remaining spatial retrofits; Scott's diagnostic is separately partial and excluded from the denominator. |
...
| Validation and Opus review | In progress | The physical-only cleanup, Ali correction, AC/DC Vault, Spider-Man Vault, AC/DC LED Pro, TSPP identity correction, Walking Dead Premium/LE, Walking Dead Pro, and Iron Man Pro Vault were approved and committed. Mustang Premium/LE/Boss has complete device dispositions; manual-versus-script trough reconciliation; all 32 physical GI emitters rather than the table's 52 render lights; manual-validated lamp and RGB-module multiplicities; dual-winding mechanisms; exact-table source hashing; visual overlay inspection; and deterministic regeneration. Every per-game commit remains gated by a fresh literal Opus `APPROVED` on the exact tree. |
...
The RFC/validator vertical slice, catalog generator, legacy import, two-corpus VPX extraction, organized manual acquisition/extraction, ROM corpus indexer, and DMD-capable reusable LibPinMAME service/gameplay harness are implemented. The Ali identity correction plus AC/DC Vault, Spider-Man Vault, AC/DC LED Pro, The Walking Dead Premium/LE, The Walking Dead Pro, and Iron Man Pro Vault spatial retrofits are committed. TSPP's incorrect IPDB 6154 identity was traced to a bad third-party VPX header, corrected to 4674, and committed at `441527b` without altering pinned/generated third-party evidence. Mustang Premium/LE/Boss is the seventh author-ready definition in this tree; the other 26 semantic baselines remain fail-closed for spatial placement. The next work package is ordered as follows:

1. Complete the fresh Opus gate and per-game commit for Mustang Premium/LE/Boss (2014), then complete Mustang Pro; preserve fail-closed status until each title has reviewed coordinate evidence and a fresh Opus-reviewed commit, process Ali's spatial work later at 1980, and finish all 26 remaining pending records before Terminator 2.
