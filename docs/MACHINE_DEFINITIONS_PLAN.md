...
| Validation and Opus review | In progress | The physical-only cleanup, Ali correction, AC/DC Vault, Spider-Man Vault, AC/DC LED Pro, TSPP identity correction, Walking Dead Premium/LE, Walking Dead Pro, Iron Man Pro Vault, Mustang Premium/LE/Boss, Mustang Pro, Star Trek Premium/LE, and Star Trek Pro were approved and committed. Star Trek Pro's correction review exposed the same pre-existing donor-table trough offset and approximate Q22 wording in Premium/LE; its switch-18 drain is being replaced by the correctly registered 18-21 physical ball chain, with jam opto 22 separately disclosed on the ejection corridor and Q22 explicitly regional. Every per-game commit remains gated by a fresh literal Opus `APPROVED` on the exact tree. |
...
1. Complete the post-review Star Trek Premium/LE trough and Q22 correction with repository-wide gates, a fresh Opus review, and a dedicated commit, then process the remaining partial physical games newest-first; preserve fail-closed status until each title has reviewed coordinate evidence and a fresh Opus-reviewed commit, process Ali's spatial work later at 1980, and finish all 23 remaining pending records before Terminator 2.
