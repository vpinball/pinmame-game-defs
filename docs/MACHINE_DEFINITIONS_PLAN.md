...
| Static catalog site | Pending after Terminator 2 | Copy the existing external `pinmame-games` static site into `site/`, configure and verify GitHub Pages for `games.visualpinball.org`, obtain Opus approval, commit, integrate to `main`, push, and verify the deployed endpoint before reporting the exact DNS target. |
...
| Validation and Opus review | In progress | The physical-only cleanup, Ali correction, AC/DC Vault, Spider-Man Vault, AC/DC LED Pro, TSPP identity correction, Walking Dead Premium/LE, Walking Dead Pro, Iron Man Pro Vault, Mustang Premium/LE/Boss, Mustang Pro, Star Trek Premium/LE, Star Trek Pro, the corrective Star Trek Premium trough/Q22 pass, Metallica Premium/LE, Metallica Pro, original AC/DC Pro, AC/DC Premium/LE/LUCI, Avengers Pro, Rolling Stones Standard, X-Men LE's fail-closed spatial-evidence pass, Avengers LE's fail-closed spatial-conflict pass, Rolling Stones Limited Edition, 24's fail-closed blocker pass, Transformers LE's fail-closed exact-evidence pass, and TRON: Legacy Limited Edition received literal Opus approval before their per-game commits. Work on X-Men Pro, Transformers Pro, TRON Pro, Avatar LE/Pro, Iron Man 2010, Spider-Man 2007, and Ripley's Believe It or Not! remains active in isolated worktrees. Every per-game commit remains gated by a fresh literal Opus `APPROVED` on its exact staged tree, followed by a separate review of the reconciled integration tree before its integration commit. |
