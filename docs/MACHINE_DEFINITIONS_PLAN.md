...
| Validation and Opus review | In progress | The physical-only cleanup, Ali correction, AC/DC Vault, Spider-Man Vault, AC/DC LED Pro, TSPP identity correction, Walking Dead Premium/LE, Walking Dead Pro, Iron Man Pro Vault, Mustang Premium/LE/Boss, Mustang Pro, Star Trek Premium/LE, Star Trek Pro, the corrective Star Trek Premium trough/Q22 pass, Metallica Premium/LE, Metallica Pro, original AC/DC Pro, AC/DC Premium/LE/LUCI, Avengers Pro, Rolling Stones Standard, X-Men LE's fail-closed spatial-evidence pass, Avengers LE's fail-closed spatial-conflict pass, Rolling Stones Limited Edition, 24's fail-closed blocker pass, Transformers LE's fail-closed exact-evidence pass, TRON: Legacy Limited Edition, Avatar LE, Spider-Man 2007, Terminator 2, and Iron Man 2010 received literal Opus approval before their per-game commits. Iron Man's corrected exact tree `4512e362` became `master` commit `6f44ae4`. Avatar Pro is the current exact-tree Opus gate; X-Men Pro, Transformers Pro, and TRON Pro remain preserved in isolated worktrees and will be finished before consolidation. Every per-game commit remains gated by a fresh literal Opus `APPROVED` on its exact staged tree. |
...
The RFC/validator vertical slice, catalog generator, legacy import, two-corpus VPX extraction, organized manual acquisition/extraction, ROM corpus indexer, DMD-capable reusable LibPinMAME service/gameplay harness, and static reference site are implemented. The completed spatial definitions include AC/DC Vault, Spider-Man Vault, the original Spider-Man (Stern 2007), AC/DC LED Pro, The Walking Dead Premium/LE, The Walking Dead Pro, Iron Man Pro Vault, original Iron Man 2010, Mustang Premium/LE/Boss, Mustang Pro, Star Trek Premium/LE, Star Trek Pro, Metallica Premium/LE, Metallica Pro, original AC/DC Pro, AC/DC Premium/LE/LUCI, Avengers Pro, Rolling Stones Standard, Rolling Stones Limited Edition, and TRON: Legacy Limited Edition. Avatar LE, X-Men LE, Avengers LE, Transformers LE, Stern 24, Terminator 2, and the current Avatar Pro pass remain spatially documented but partial while their explicit authoring blockers are unresolved. Fourteen definitions explicitly report missing spatial placement; this includes processed fail-closed games and is not a count of untouched work items. The next work package is ordered as follows:

1. Finish literal Opus review and per-game commits for Avatar Pro, Transformers Pro, TRON Pro, and X-Men Pro; preserve fail-closed status wherever the recorded crosswalks remain incomplete, consolidate the reviewed result and existing static site on `master`, clean completed worktrees, move `master` to the user-requested root checkout, and pause without beginning another game.
