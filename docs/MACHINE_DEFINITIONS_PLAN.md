...
Status: Implementation in progress (2026-08-03, 57%), based on the Opus-reviewed architecture and the discussion in [pinmame-game-defs PR #1](https://github.com/vpinball/pinmame-game-defs/pull/1). The physical-only cleanup was approved and committed at `e53d7c7`, the Ali physical-family correction at `59bf6bb`, AC/DC Vault Edition at `252c740`, Spider-Man Vault Edition at `c4568f5`, AC/DC LED Pro at `2a16295`, the Simpsons Pinball Party IPDB identity correction at `441527b`, The Walking Dead Premium/LE at `5e89ad4`, and The Walking Dead Pro at `31e8902`. Iron Man Pro Vault Edition is implemented, fully validated, and awaiting its fresh Opus approval as the active spatial retrofit. The remaining 27 semantic baselines stay fail-closed until each has reviewed coordinate evidence; Terminator 2 remains deferred until all 33 spatial retrofits are complete.
...
| Author-ready definitions | In progress | The pinned public API returns 2,873 drivers; seven custom-ROM-only virtual-table drivers are excluded, leaving 2,866 in-scope drivers grouped into 785 physical-game records plus one explicitly classified non-game diagnostic. AC/DC Vault, Spider-Man Vault, AC/DC LED Pro, The Walking Dead Premium/LE, and The Walking Dead Pro are committed; Iron Man Pro Vault is the sixth author-ready definition pending its per-game Opus gate. The regenerated catalog yields 6/785 author-ready games, 96 partial games, 683 conspicuous game stubs, and 27 remaining spatial retrofits; Scott's diagnostic is separately partial and excluded from the denominator. |
...
| Validation and Opus review | In progress | The physical-only cleanup, Ali correction, AC/DC Vault, Spider-Man Vault, AC/DC LED Pro, TSPP identity correction, Walking Dead Premium/LE, and Walking Dead Pro were approved and committed. Iron Man Pro Vault now passes 246 full-suite tests, repository validation, compileall, diff checking, complete device dispositions, 39/40-cabinet GI reconciliation including the two above-playfield #555 sources, documented flasher/lamp multiplicities, independent manual-map calibration, visual overlay inspection, and deterministic regeneration (SHA-256 `6d6db85b5cea1662edc9a2ccf17ae4574e6f8bd6ac2bebb0d0ce4099bfabcc5c` three times); the first Opus review's six findings are remediated and fresh exact-tree approval remains the hard pre-commit gate. |
...
The RFC/validator vertical slice, catalog generator, legacy import, two-corpus VPX extraction, organized manual acquisition/extraction, ROM corpus indexer, and DMD-capable reusable LibPinMAME service/gameplay harness are implemented. The Ali identity correction plus AC/DC Vault, Spider-Man Vault, AC/DC LED Pro, The Walking Dead Premium/LE, and The Walking Dead Pro spatial retrofits are committed. TSPP's incorrect IPDB 6154 identity was traced to a bad third-party VPX header, corrected to 4674, and committed at `441527b` without altering pinned/generated third-party evidence. Iron Man Pro Vault is fully validated and pending only its Opus gate; the other 27 semantic baselines remain fail-closed for spatial placement. The next work package is ordered as follows:

1. Validate, review, and commit Iron Man Pro Vault Edition (2014), then complete Mustang Premium/LE/Boss and Mustang Pro; preserve fail-closed status until each title has reviewed coordinate evidence and a fresh Opus-reviewed commit, process Ali's spatial work later at 1980, and finish all 27 remaining pending records before Terminator 2.
