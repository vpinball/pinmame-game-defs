...
Status: Implementation in progress (2026-08-03, 55%), based on the Opus-reviewed architecture and the discussion in [pinmame-game-defs PR #1](https://github.com/vpinball/pinmame-game-defs/pull/1). The physical-only cleanup was approved and committed at `e53d7c7`, the Ali physical-family correction at `59bf6bb`, AC/DC Vault Edition at `252c740`, Spider-Man Vault Edition at `c4568f5`, AC/DC LED Pro at `2a16295`, and the Simpsons Pinball Party IPDB identity correction at `441527b`. The Walking Dead Premium/LE is implemented and Opus-approved locally as the fourth author-ready spatial definition and awaits only its per-game commit. The remaining 29 semantic baselines stay fail-closed until each has reviewed coordinate evidence; Terminator 2 remains deferred until all 33 spatial retrofits are complete.
...
| Author-ready definitions | In progress | The pinned public API returns 2,873 drivers; seven custom-ROM-only virtual-table drivers are excluded, leaving 2,866 in-scope drivers grouped into 785 physical-game records plus one explicitly classified non-game diagnostic. AC/DC Vault, Spider-Man Vault, and AC/DC LED Pro are committed as the first three spatially author-ready games; The Walking Dead Premium/LE is the locally implemented fourth. The regenerated catalog yields 4/785 author-ready games, 98 partial games, 683 conspicuous game stubs, and 29 remaining spatial retrofits; Scott's diagnostic is separately partial and excluded from the denominator. |
...
| Validation and Opus review | In progress | The physical-only cleanup, Ali correction, AC/DC Vault, Spider-Man Vault, AC/DC LED Pro, and TSPP identity correction were approved and committed. Opus's first correction review of Walking Dead Premium/LE found the GI panel view derivation, 1-based firmware-ID mapping, trace provenance, and regeneration path insufficiently explicit. Its second pass independently verified the ROM mapping and eight of nine corrections, then retained one blocker because the panel handedness had been justified with drafting lettering rather than physical mounting evidence. The final revision derives the service/rear face from the exposed `077-5000-00` staple-bayonet socket hardware and rear connector/board enclosure, explicitly rejects the lettering as evidence, and trims the diagnostic locator to its own observation. It passes 243 full-suite tests, repository validation, deterministic regeneration (SHA-256 `a9f51255e4ad2af33fdb181cebd763c5d0eb653be6448fc3ce6973b440841ab7` three times), exact spatial dispositions and emitter quantities, and an unchanged regenerated overlay SHA-256 `1a676937eb4488abf35ac003256831ca90502f0b27005f1a2c495d9b6c9d4c33`. Opus independently rechecked the manual cue, trace event, hashes, 215 placements, GI quantities, generated counts, and returned **APPROVED**. |
...
The RFC/validator vertical slice, catalog generator, legacy import, two-corpus VPX extraction, organized manual acquisition/extraction, ROM corpus indexer, and DMD-capable reusable LibPinMAME service/gameplay harness are implemented. The Ali identity correction plus AC/DC Vault, Spider-Man Vault, and AC/DC LED Pro spatial retrofits are committed. TSPP's incorrect IPDB 6154 identity was traced to a bad third-party VPX header, corrected to 4674, and committed at `441527b` without altering pinned/generated third-party evidence. The Walking Dead Premium/LE (2014) spatial promotion is implemented and Opus-approved locally, including an exact-ROM correction of its four extended GI identities; the other 29 semantic baselines remain fail-closed for spatial placement. The next work package is ordered as follows:

1. Commit the Opus-approved Walking Dead Premium/LE (2014) spatial promotion as its own per-game commit.
2. Continue with The Walking Dead Pro (2014), then proceed newest physical release first; preserve fail-closed status until each title has reviewed coordinate evidence and a fresh Opus-reviewed commit, process Ali's spatial work later at 1980, and finish all 29 remaining pending records before Terminator 2.
